...
pub fn new(region region: String) -> Client {
  Client(awsjson_client.default_config(region, "jsonprotocol", "jsonprotocol"))
}
...
pub fn encode_datetime_offsets_output_struct_top(input: DatetimeOffsetsOutput) -> json.Json {
  let pairs = []
  let pairs = case input.datetime {
    option.Some(v) -> [#("datetime", fn(v) { json.string(json_timestamp.format_iso8601(v)) }(v)), ..pairs]
    option.None -> pairs
...
pub fn encode_host_label_input_struct_top(input: HostLabelInput) -> json.Json {
  let pairs = []
  let pairs = case input.label {
    option.Some(v) -> [#("label", json.string(v)), ..pairs]
    option.None -> pairs
...
pub fn encode_fractional_seconds_output_struct_top(input: FractionalSecondsOutput) -> json.Json {
  let pairs = []
  let pairs = case input.datetime {
    option.Some(v) -> [#("datetime", fn(v) { json.string(json_timestamp.format_iso8601(v)) }(v)), ..pairs]
    option.None -> pairs
...
pub fn encode_json_enums_input_output_struct_top(input: JsonEnumsInputOutput) -> json.Json {
  let pairs = []
  let pairs = case input.foo_enum1 {
    option.Some(v) -> [#("fooEnum1", encode_foo_enum_enum(v)), ..pairs]
    option.None -> pairs
...
pub type JsonIntEnumsInputOutput {
  JsonIntEnumsInputOutput(int_enum1: option.Option(IntegerEnum), int_enum2: option.Option(IntegerEnum), int_enum3: option.Option(IntegerEnum), int_enum_list: option.Option(List(IntegerEnum)), int_enum_map: option.Option(dict.Dict(String, IntegerEnum)), int_enum_set: option.Option(List(IntegerEnum)))
}
...
pub fn encode_json_int_enums_input_output_struct_top(input: JsonIntEnumsInputOutput) -> json.Json {
  let pairs = []
  let pairs = case input.int_enum1 {
    option.Some(v) -> [#("intEnum1", encode_integer_enum_int_enum(v)), ..pairs]
    option.None -> pairs
...
pub fn encode_union_input_output_struct_top(input: UnionInputOutput) -> json.Json {
  let pairs = []
  let pairs = case input.contents {
    option.Some(v) -> [#("contents", encode_my_union_union(v)), ..pairs]
    option.None -> pairs
...
pub type KitchenSink {
  KitchenSink(blob: option.Option(BitArray), boolean: option.Option(Bool), double: option.Option(json_float.SmithyFloat), empty_struct: option.Option(EmptyStruct), float: option.Option(json_float.SmithyFloat), httpdate_timestamp: option.Option(Int), integer: option.Option(Int), iso8601_timestamp: option.Option(Int), json_value: option.Option(String), list_of_lists: option.Option(List(List(String))), list_of_maps_of_strings: option.Option(List(dict.Dict(String, String))), list_of_strings: option.Option(List(String)), list_of_structs: option.Option(List(SimpleStruct)), long: option.Option(Int), map_of_lists_of_strings: option.Option(dict.Dict(String, List(String))), map_of_maps: option.Option(dict.Dict(String, dict.Dict(String, String))), map_of_strings: option.Option(dict.Dict(String, String)), map_of_structs: option.Option(dict.Dict(String, SimpleStruct)), recursive_list: option.Option(List(KitchenSink)), recursive_map: option.Option(dict.Dict(String, KitchenSink)), recursive_struct: option.Option(KitchenSink), simple_struct: option.Option(SimpleStruct), string: option.Option(String), struct_with_json_name: option.Option(StructWithJsonName), timestamp: option.Option(Int), unix_timestamp: option.Option(Int))
}
...
pub fn encode_kitchen_sink_struct_top(input: KitchenSink) -> json.Json {
  let pairs = []
  let pairs = case input.blob {
    option.Some(v) -> [#("Blob", fn(b) { json.string(bit_array.base64_encode(b, True)) }(v)), ..pairs]
    option.None -> pairs
...
pub fn decode_kitchen_sink_struct() -> decode.Decoder(KitchenSink) {
  ...
  use httpdate_timestamp <- decode.optional_field("HttpdateTimestamp", option.None, decode.optional(json_timestamp.decoder()))
  use integer <- decode.optional_field("Integer", option.None, decode.optional(decode.int))
  use iso8601_timestamp <- decode.optional_field("Iso8601Timestamp", option.None, decode.optional(json_timestamp.decoder()))
  ...
  use unix_timestamp <- decode.optional_field("UnixTimestamp", option.None, decode.optional(json_timestamp.decoder()))
...
pub fn decode_kitchen_sink_struct_params() -> decode.Decoder(KitchenSink) {
  use blob <- decode.optional_field("Blob", option.None, decode.optional(decode.then(decode.string, fn(s) { decode.success(bit_array.from_string(s)) })))
  use boolean <- decode.optional_field("Boolean", option.None, decode.optional(decode.bool))
  use double <- decode.optional_field("Double", option.None, decode.optional(json_float.decoder()))
  use empty_struct <- decode.optional_field("EmptyStruct", option.None, decode.optional(decode_empty_struct_struct_params()))
  use float <- decode.optional_field("Float", option.None, decode.optional(json_float.decoder()))
  use httpdate_timestamp <- decode.optional_field("HttpdateTimestamp", option.None, decode.optional(json_timestamp.decoder()))
  use integer <- decode.optional_field("Integer", option.None, decode.optional(decode.int))
  use iso8601_timestamp <- decode.optional_field("Iso8601Timestamp", option.None, decode.optional(json_timestamp.decoder()))
  ...
  use list_of_maps_of_strings <- decode.optional_field("ListOfMapsOfStrings", option.None, decode.optional(decode.list(decode.dict(decode.string, decode.string))))
  use list_of_strings <- decode.optional_field("ListOfStrings", option.None, decode.optional(decode.list(decode.string)))
  use list_of_structs <- decode.optional_field("ListOfStructs", option.None, decode.optional(decode.list(decode_simple_struct_struct_params())))
  use long <- decode.optional_field("Long", option.None, decode.optional(decode.int))
  use map_of_lists_of_strings <- decode.optional_field("MapOfListsOfStrings", option.None, decode.optional(decode.dict(decode.string, decode.list(decode.string))))
  use map_of_maps <- decode.optional_field("MapOfMaps", option.None, decode.optional(decode.dict(decode.string, decode.dict(decode.string, decode.string))))
  use map_of_strings <- decode.optional_field("MapOfStrings", option.None, decode.optional(decode.dict(decode.string, decode.string)))
  use map_of_structs <- decode.optional_field("MapOfStructs", option.None, decode.optional(decode.dict(decode.string, decode_simple_struct_struct_params())))
  use recursive_list <- decode.optional_field("RecursiveList", option.None, decode.optional(decode.list(decode_kitchen_sink_struct_params())))
  use recursive_map <- decode.optional_field("RecursiveMap", option.None, decode.optional(decode.dict(decode.string, decode_kitchen_sink_struct_params())))
  use recursive_struct <- decode.optional_field("RecursiveStruct", option.None, decode.optional(decode_kitchen_sink_struct_params()))
  use simple_struct <- decode.optional_field("SimpleStruct", option.None, decode.optional(decode_simple_struct_struct_params()))
  use string <- decode.optional_field("String", option.None, decode.optional(decode.string))
  use struct_with_json_name <- decode.optional_field("StructWithJsonName", option.None, decode.optional(decode_struct_with_json_name_struct_params()))
  use timestamp <- decode.optional_field("Timestamp", option.None, decode.optional(json_timestamp.decoder()))
  use unix_timestamp <- decode.optional_field("UnixTimestamp", option.None, decode.optional(json_timestamp.decoder()))
  decode.success(KitchenSink(
    blob: blob,
...
pub fn encode_empty_struct_struct_top(_v: EmptyStruct) -> json.Json {
  json.object([])
}
...
pub fn decode_empty_struct_struct_params() -> decode.Decoder(EmptyStruct) {
  decode.success(EmptyStruct)
}
...
pub fn encode_simple_struct_struct_top(input: SimpleStruct) -> json.Json {
  let pairs = []
  let pairs = case input.value {
    option.Some(v) -> [#("Value", json.string(v)), ..pairs]
    option.None -> pairs
...
pub fn decode_simple_struct_struct_params() -> decode.Decoder(SimpleStruct) {
  use value <- decode.optional_field("Value", option.None, decode.optional(decode.string))
  decode.success(SimpleStruct(
    value: value,
  ))
...
pub fn encode_struct_with_json_name_struct_top(input: StructWithJsonName) -> json.Json {
  let pairs = []
  let pairs = case input.value {
    option.Some(v) -> [#("Value", json.string(v)), ..pairs]
    option.None -> pairs
...
pub fn decode_struct_with_json_name_struct_params() -> decode.Decoder(StructWithJsonName) {
  use value <- decode.optional_field("Value", option.None, decode.optional(decode.string))
  decode.success(StructWithJsonName(
    value: value,
  ))
...
pub type ErrorWithMembers {
  ErrorWithMembers(code: option.Option(String), complex_data: option.Option(KitchenSink), integer_field: option.Option(Int), list_field: option.Option(List(String)), map_field: option.Option(dict.Dict(String, String)), message: option.Option(String), string_field: option.Option(String))
}
...
pub fn encode_error_with_members_struct_top(input: ErrorWithMembers) -> json.Json {
  let pairs = []
  let pairs = case input.code {
    option.Some(v) -> [#("Code", json.string(v)), ..pairs]
    option.None -> pairs
...
pub fn decode_error_with_members_struct_params() -> decode.Decoder(ErrorWithMembers) {
  use code <- decode.optional_field("Code", option.None, decode.optional(decode.string))
  use complex_data <- decode.optional_field("ComplexData", option.None, decode.optional(decode_kitchen_sink_struct_params()))
  use integer_field <- decode.optional_field("IntegerField", option.None, decode.optional(decode.int))
  use list_field <- decode.optional_field("ListField", option.None, decode.optional(decode.list(decode.string)))
  use map_field <- decode.optional_field("MapField", option.None, decode.optional(decode.dict(decode.string, decode.string)))
  use message <- decode.optional_field("Message", option.None, decode.optional(decode.string))
...
pub fn encode_error_without_members_struct_top(_v: ErrorWithoutMembers) -> json.Json {
  json.object([])
}
...
pub fn decode_error_without_members_struct_params() -> decode.Decoder(ErrorWithoutMembers) {
  decode.success(ErrorWithoutMembers)
}
...
pub fn encode_null_operation_input_output_struct_top(input: NullOperationInputOutput) -> json.Json {
  let pairs = []
  let pairs = case input.string {
    option.Some(v) -> [#("string", json.string(v)), ..pairs]
    option.None -> pairs
...
pub fn decode_null_operation_input_output_struct_params() -> decode.Decoder(NullOperationInputOutput) {
  use string <- decode.optional_field("string", option.None, decode.optional(decode.string))
  decode.success(NullOperationInputOutput(
    string: string,
  ))
...
pub fn encode_operation_with_optional_input_output_input_struct_top(input: OperationWithOptionalInputOutputInput) -> json.Json {
  let pairs = []
  let pairs = case input.value {
    option.Some(v) -> [#("Value", json.string(v)), ..pairs]
    option.None -> pairs
...
pub fn decode_operation_with_optional_input_output_input_struct_params() -> decode.Decoder(OperationWithOptionalInputOutputInput) {
  use value <- decode.optional_field("Value", option.None, decode.optional(decode.string))
  decode.success(OperationWithOptionalInputOutputInput(
    value: value,
  ))
...
pub fn encode_operation_with_optional_input_output_output_struct_top(input: OperationWithOptionalInputOutputOutput) -> json.Json {
  let pairs = []
  let pairs = case input.value {
    option.Some(v) -> [#("Value", json.string(v)), ..pairs]
    option.None -> pairs
...
pub fn decode_operation_with_optional_input_output_output_struct_params() -> decode.Decoder(OperationWithOptionalInputOutputOutput) {
  use value <- decode.optional_field("Value", option.None, decode.optional(decode.string))
  decode.success(OperationWithOptionalInputOutputOutput(
    value: value,
  ))
...
pub fn encode_put_and_get_inline_documents_input_output_struct_top(input: PutAndGetInlineDocumentsInputOutput) -> json.Json {
  let pairs = []
  let pairs = case input.inline_document {
    option.Some(v) -> [#("inlineDocument", fn(j) { j }(v)), ..pairs]
    option.None -> pairs
...
pub fn decode_put_and_get_inline_documents_input_output_struct() -> decode.Decoder(PutAndGetInlineDocumentsInputOutput) {
  use inline_document <- decode.optional_field("inlineDocument", option.None, decode.optional(json_document.decoder()))
  decode.success(PutAndGetInlineDocumentsInputOutput(
    inline_document: inline_document,
  ))
}

pub fn decode_put_and_get_inline_documents_input_output_struct_params() -> decode.Decoder(PutAndGetInlineDocumentsInputOutput) {
  use inline_document <- decode.optional_field("inlineDocument", option.None, decode.optional(json_document.decoder()))
  decode.success(PutAndGetInlineDocumentsInputOutput(
    inline_document: inline_document,
  ))
...
pub type SimpleScalarPropertiesInputOutput {
  SimpleScalarPropertiesInputOutput(double_value: option.Option(json_float.SmithyFloat), float_value: option.Option(json_float.SmithyFloat))
}
...
pub fn encode_simple_scalar_properties_input_output_struct_top(input: SimpleScalarPropertiesInputOutput) -> json.Json {
  let pairs = []
  let pairs = case input.double_value {
    option.Some(v) -> [#("doubleValue", json_float.encode(v)), ..pairs]
    option.None -> pairs
...
pub type SparseNullsOperationInputOutput {
  SparseNullsOperationInputOutput(sparse_string_list: option.Option(List(option.Option(String))), sparse_string_map: option.Option(dict.Dict(String, option.Option(String))))
}
...
pub fn encode_sparse_nulls_operation_input_output_struct_top(input: SparseNullsOperationInputOutput) -> json.Json {
  let pairs = []
  let pairs = case input.sparse_string_list {
    option.Some(v) -> [#("sparseStringList", fn(xs) { json.array(xs, fn(o) { case o { option.Some(x) -> json.string(x) option.None -> json.null() } }) }(v)), ..pairs]
    option.None -> pairs
...
pub fn encode_endpoint_with_host_label_operation_input(input: HostLabelInput) -> String {
  json.to_string(encode_host_label_input_struct_top(input))
}

pub fn decode_endpoint_with_host_label_operation_input(body: String) -> Result(HostLabelInput, String) {
  case json.parse(body, decode_host_label_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}
...
pub fn encode_json_enums_input(input: JsonEnumsInputOutput) -> String {
  json.to_string(encode_json_enums_input_output_struct_top(input))
}

pub fn decode_json_enums_input(body: String) -> Result(JsonEnumsInputOutput, String) {
  case json.parse(body, decode_json_enums_input_output_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}
...
pub fn encode_json_int_enums_input(input: JsonIntEnumsInputOutput) -> String {
  json.to_string(encode_json_int_enums_input_output_struct_top(input))
}

pub fn decode_json_int_enums_input(body: String) -> Result(JsonIntEnumsInputOutput, String) {
  case json.parse(body, decode_json_int_enums_input_output_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}
...
pub fn encode_json_unions_input(input: UnionInputOutput) -> String {
  json.to_string(encode_union_input_output_struct_top(input))
}

pub fn decode_json_unions_input(body: String) -> Result(UnionInputOutput, String) {
  case json.parse(body, decode_union_input_output_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}
...
pub fn encode_kitchen_sink_operation_input(input: KitchenSink) -> String {
  json.to_string(encode_kitchen_sink_struct_top(input))
}

pub fn decode_kitchen_sink_operation_input(body: String) -> Result(KitchenSink, String) {
  case json.parse(body, decode_kitchen_sink_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}
...
pub fn encode_null_operation_input(input: NullOperationInputOutput) -> String {
  json.to_string(encode_null_operation_input_output_struct_top(input))
}

pub fn decode_null_operation_input(body: String) -> Result(NullOperationInputOutput, String) {
  case json.parse(body, decode_null_operation_input_output_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}
...
pub fn encode_operation_with_optional_input_output_input(input: OperationWithOptionalInputOutputInput) -> String {
  json.to_string(encode_operation_with_optional_input_output_input_struct_top(input))
}

pub fn decode_operation_with_optional_input_output_input(body: String) -> Result(OperationWithOptionalInputOutputInput, String) {
  case json.parse(body, decode_operation_with_optional_input_output_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}
...
pub fn encode_put_and_get_inline_documents_input(input: PutAndGetInlineDocumentsInputOutput) -> String {
  json.to_string(encode_put_and_get_inline_documents_input_output_struct_top(input))
}

pub fn decode_put_and_get_inline_documents_input(body: String) -> Result(PutAndGetInlineDocumentsInputOutput, String) {
  case json.parse(body, decode_put_and_get_inline_documents_input_output_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}
...
pub fn encode_simple_scalar_properties_input(input: SimpleScalarPropertiesInputOutput) -> String {
  json.to_string(encode_simple_scalar_properties_input_output_struct_top(input))
}

pub fn decode_simple_scalar_properties_input(body: String) -> Result(SimpleScalarPropertiesInputOutput, String) {
  case json.parse(body, decode_simple_scalar_properties_input_output_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}
...
pub fn encode_sparse_nulls_operation_input(input: SparseNullsOperationInputOutput) -> String {
  json.to_string(encode_sparse_nulls_operation_input_output_struct_top(input))
}

pub fn decode_sparse_nulls_operation_input(body: String) -> Result(SparseNullsOperationInputOutput, String) {
  case json.parse(body, decode_sparse_nulls_operation_input_output_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}
