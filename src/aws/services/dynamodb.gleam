...
pub fn encode_return_consumed_capacity_enum(v: ReturnConsumedCapacity) -> json.Json {
  case v {
...
pub fn decode_return_consumed_capacity_enum() -> decode.Decoder(ReturnConsumedCapacity) {
...
pub fn encode_attribute_value_union(v: AttributeValue) -> json.Json {
  case v {
    AttributeValueB(x) -> json.object([#("B", fn(b) { json.string(bit_array.base64_encode(b, True)) }(x))])
    AttributeValueBOOL(x) -> json.object([#("BOOL", json.bool(x))])
    AttributeValueBS(x) -> json.object([#("BS", fn(xs) { json.array(xs, fn(b) { json.string(bit_array.base64_encode(b, True)) }) }(x))])
    AttributeValueL(x) -> json.object([#("L", fn(xs) { json.array(xs, encode_attribute_value_union) }(x))])
    AttributeValueM(x) -> json.object([#("M", fn(d) { json.object(dict.to_list(d) |> list.map(fn(pair) { #(pair.0, encode_attribute_value_union(pair.1)) })) }(x))])
    AttributeValueN(x) -> json.object([#("N", json.string(x))])
    AttributeValueNS(x) -> json.object([#("NS", fn(xs) { json.array(xs, json.string) }(x))])
    AttributeValueNULL(x) -> json.object([#("NULL", json.bool(x))])
    AttributeValueS(x) -> json.object([#("S", json.string(x))])
    AttributeValueSS(x) -> json.object([#("SS", fn(xs) { json.array(xs, json.string) }(x))])
  }
}
...
pub fn encode_return_values_on_condition_check_failure_enum(v: ReturnValuesOnConditionCheckFailure) -> json.Json {
  case v {
...
pub fn decode_return_values_on_condition_check_failure_enum() -> decode.Decoder(ReturnValuesOnConditionCheckFailure) {
  decode.then(decode.string, fn(s) {
    case s {
      ...
      _ -> decode.failure(ReturnValuesOnConditionCheckFailureAllOld, "unknown enum value")
    }
  })
}
...
pub fn decode_consumed_capacity_struct() -> decode.Decoder(ConsumedCapacity) {
  ...
  use table <- decode.optional_field("Table", option.None, decode.optional(decode_capacity_struct()))
...
pub fn decode_consumed_capacity_struct_params() -> decode.Decoder(ConsumedCapacity) {
  ...
  use read_capacity_units <- decode.optional_field("ReadCapacityUnits", option.None, decode.optional(json_float.decoder()))
  use table <- decode.optional_field("Table", option.None, decode.optional(decode_capacity_struct_params()))
  use table_name <- decode.optional_field("TableName", option.None, decode.optional(decode.string))
  use write_capacity_units <- decode.optional_field("WriteCapacityUnits", option.None, decode.optional(json_float.decoder()))
  decode.success(ConsumedCapacity(
    capacity_units: capacity_units,
...
pub fn encode_batch_statement_error_code_enum_enum(v: BatchStatementErrorCodeEnum) -> json.Json {
  case v {
    BatchStatementErrorCodeEnumAccessdenied -> json.string("AccessDenied")
    BatchStatementErrorCodeEnumConditionalcheckfailed -> json.string("ConditionalCheckFailed")
    BatchStatementErrorCodeEnumDuplicateitem -> json.string("DuplicateItem")
    BatchStatementErrorCodeEnumInternalservererror -> json.string("InternalServerError")
    BatchStatementErrorCodeEnumItemcollectionsizelimitexceeded -> json.string("ItemCollectionSizeLimitExceeded")
    BatchStatementErrorCodeEnumProvisionedthroughputexceeded -> json.string("ProvisionedThroughputExceeded")
    BatchStatementErrorCodeEnumRequestlimitexceeded -> json.string("RequestLimitExceeded")
    BatchStatementErrorCodeEnumResourcenotfound -> json.string("ResourceNotFound")
    BatchStatementErrorCodeEnumThrottlingerror -> json.string("ThrottlingError")
    BatchStatementErrorCodeEnumTransactionconflict -> json.string("TransactionConflict")
    BatchStatementErrorCodeEnumValidationerror -> json.string("ValidationError")
  }
}

pub fn decode_batch_statement_error_code_enum_enum() -> decode.Decoder(BatchStatementErrorCodeEnum) {
  decode.then(decode.string, fn(s) {
    case s {
      "AccessDenied" -> decode.success(BatchStatementErrorCodeEnumAccessdenied)
      "ConditionalCheckFailed" -> decode.success(BatchStatementErrorCodeEnumConditionalcheckfailed)
      "DuplicateItem" -> decode.success(BatchStatementErrorCodeEnumDuplicateitem)
      "InternalServerError" -> decode.success(BatchStatementErrorCodeEnumInternalservererror)
      "ItemCollectionSizeLimitExceeded" -> decode.success(BatchStatementErrorCodeEnumItemcollectionsizelimitexceeded)
      "ProvisionedThroughputExceeded" -> decode.success(BatchStatementErrorCodeEnumProvisionedthroughputexceeded)
      "RequestLimitExceeded" -> decode.success(BatchStatementErrorCodeEnumRequestlimitexceeded)
      "ResourceNotFound" -> decode.success(BatchStatementErrorCodeEnumResourcenotfound)
      "ThrottlingError" -> decode.success(BatchStatementErrorCodeEnumThrottlingerror)
      "TransactionConflict" -> decode.success(BatchStatementErrorCodeEnumTransactionconflict)
      "ValidationError" -> decode.success(BatchStatementErrorCodeEnumValidationerror)
      _ -> decode.failure(BatchStatementErrorCodeEnumAccessdenied, "unknown enum value")
    }
  })
}
...
pub fn encode_return_item_collection_metrics_enum(v: ReturnItemCollectionMetrics) -> json.Json {
  case v {
...
pub fn decode_return_item_collection_metrics_enum() -> decode.Decoder(ReturnItemCollectionMetrics) {
  decode.then(decode.string, fn(s) {
    case s {
...
pub fn decode_backup_details_struct() -> decode.Decoder(BackupDetails) {
  ...
  use backup_name <- decode.optional_field("BackupName", option.None, decode.optional(decode.string))
  use backup_size_bytes <- decode.optional_field("BackupSizeBytes", option.None, decode.optional(decode.int))
  use backup_status <- decode.optional_field("BackupStatus", option.None, decode.optional(decode_backup_status_enum()))
  use backup_type <- decode.optional_field("BackupType", option.None, decode.optional(decode_backup_type_enum()))
...
pub fn decode_global_table_description_struct() -> decode.Decoder(GlobalTableDescription) {
  ...
  use global_table_name <- decode.optional_field("GlobalTableName", option.None, decode.optional(decode.string))
  use global_table_status <- decode.optional_field("GlobalTableStatus", option.None, decode.optional(decode_global_table_status_enum()))
  use replication_group <- decode.optional_field("ReplicationGroup", option.None, decode.optional(decode.list(decode_replica_description_struct())))
...
pub fn decode_global_table_description_struct_params() -> decode.Decoder(GlobalTableDescription) {
  ...
  use global_table_name <- decode.optional_field("GlobalTableName", option.None, decode.optional(decode.string))
  use global_table_status <- decode.optional_field("GlobalTableStatus", option.None, decode.optional(decode_global_table_status_enum()))
  use replication_group <- decode.optional_field("ReplicationGroup", option.None, decode.optional(decode.list(decode_replica_description_struct_params())))
  decode.success(GlobalTableDescription(
    creation_date_time: creation_date_time,
    global_table_arn: global_table_arn,
    global_table_name: global_table_name,
...
pub fn decode_replica_description_struct() -> decode.Decoder(ReplicaDescription) {
  ...
  use region_name <- decode.optional_field("RegionName", option.None, decode.optional(decode.string))
  use replica_arn <- decode.optional_field("ReplicaArn", option.None, decode.optional(decode.string))
  use replica_inaccessible_date_time <- decode.optional_field("ReplicaInaccessibleDateTime", option.None, decode.optional(json_timestamp.decoder()))
  use replica_status <- decode.optional_field("ReplicaStatus", option.None, decode.optional(decode_replica_status_enum()))
  use replica_status_description <- decode.optional_field("ReplicaStatusDescription", option.None, decode.optional(decode.string))
  use replica_status_percent_progress <- decode.optional_field("ReplicaStatusPercentProgress", option.None, decode.optional(decode.string))
  use replica_table_class_summary <- decode.optional_field("ReplicaTableClassSummary", option.None, decode.optional(decode_table_class_summary_struct()))
  use warm_throughput <- decode.optional_field("WarmThroughput", option.None, decode.optional(decode_table_warm_throughput_description_struct()))
...
pub fn decode_replica_description_struct_params() -> decode.Decoder(ReplicaDescription) {
  ...
  use replica_status_description <- decode.optional_field("ReplicaStatusDescription", option.None, decode.optional(decode.string))
  use replica_status_percent_progress <- decode.optional_field("ReplicaStatusPercentProgress", option.None, decode.optional(decode.string))
  use replica_table_class_summary <- decode.optional_field("ReplicaTableClassSummary", option.None, decode.optional(decode_table_class_summary_struct_params()))
  use warm_throughput <- decode.optional_field("WarmThroughput", option.None, decode.optional(decode_table_warm_throughput_description_struct_params()))
  decode.success(ReplicaDescription(
    global_secondary_indexes: global_secondary_indexes,
    global_table_settings_replication_mode: global_table_settings_replication_mode,
    kms_master_key_id: kms_master_key_id,
...
pub fn decode_replica_global_secondary_index_description_struct() -> decode.Decoder(ReplicaGlobalSecondaryIndexDescription) {
  ...
  use on_demand_throughput_override <- decode.optional_field("OnDemandThroughputOverride", option.None, decode.optional(decode_on_demand_throughput_override_struct()))
  use provisioned_throughput_override <- decode.optional_field("ProvisionedThroughputOverride", option.None, decode.optional(decode_provisioned_throughput_override_struct()))
  use warm_throughput <- decode.optional_field("WarmThroughput", option.None, decode.optional(decode_global_secondary_index_warm_throughput_description_struct()))
...
pub fn decode_replica_global_secondary_index_description_struct_params() -> decode.Decoder(ReplicaGlobalSecondaryIndexDescription) {
  ...
  use on_demand_throughput_override <- decode.optional_field("OnDemandThroughputOverride", option.None, decode.optional(decode_on_demand_throughput_override_struct_params()))
  use provisioned_throughput_override <- decode.optional_field("ProvisionedThroughputOverride", option.None, decode.optional(decode_provisioned_throughput_override_struct_params()))
  use warm_throughput <- decode.optional_field("WarmThroughput", option.None, decode.optional(decode_global_secondary_index_warm_throughput_description_struct_params()))
  decode.success(ReplicaGlobalSecondaryIndexDescription(
    index_name: index_name,
    on_demand_throughput_override: on_demand_throughput_override,
    provisioned_throughput_override: provisioned_throughput_override,
...
pub fn encode_global_table_settings_replication_mode_enum(v: GlobalTableSettingsReplicationMode) -> json.Json {
  case v {
    ...
    GlobalTableSettingsReplicationModeEnabledWithOverrides -> json.string("ENABLED_WITH_OVERRIDES")
  }
}

pub fn decode_global_table_settings_replication_mode_enum() -> decode.Decoder(GlobalTableSettingsReplicationMode) {
  decode.then(decode.string, fn(s) {
    case s {
      ...
      "ENABLED_WITH_OVERRIDES" -> decode.success(GlobalTableSettingsReplicationModeEnabledWithOverrides)
      _ -> decode.failure(GlobalTableSettingsReplicationModeDisabled, "unknown enum value")
    }
  })
}
...
pub fn encode_replica_status_enum(v: ReplicaStatus) -> json.Json {
  case v {
    ...
    ReplicaStatusInaccessibleEncryptionCredentials -> json.string("INACCESSIBLE_ENCRYPTION_CREDENTIALS")
    ReplicaStatusRegionDisabled -> json.string("REGION_DISABLED")
    ReplicaStatusReplicationNotAuthorized -> json.string("REPLICATION_NOT_AUTHORIZED")
...
pub fn decode_replica_status_enum() -> decode.Decoder(ReplicaStatus) {
  decode.then(decode.string, fn(s) {
    case s {
      ...
      "INACCESSIBLE_ENCRYPTION_CREDENTIALS" -> decode.success(ReplicaStatusInaccessibleEncryptionCredentials)
      "REGION_DISABLED" -> decode.success(ReplicaStatusRegionDisabled)
      "REPLICATION_NOT_AUTHORIZED" -> decode.success(ReplicaStatusReplicationNotAuthorized)
...
pub fn encode_table_class_enum(v: TableClass) -> json.Json {
  case v {
    ...
    TableClassStandardInfrequentAccess -> json.string("STANDARD_INFREQUENT_ACCESS")
  }
}
...
pub fn decode_table_class_enum() -> decode.Decoder(TableClass) {
  decode.then(decode.string, fn(s) {
    case s {
      ...
      "STANDARD_INFREQUENT_ACCESS" -> decode.success(TableClassStandardInfrequentAccess)
...
pub fn encode_table_status_enum(v: TableStatus) -> json.Json {
  case v {
    ...
    TableStatusInaccessibleEncryptionCredentials -> json.string("INACCESSIBLE_ENCRYPTION_CREDENTIALS")
    TableStatusReplicationNotAuthorized -> json.string("REPLICATION_NOT_AUTHORIZED")
...
pub fn decode_table_status_enum() -> decode.Decoder(TableStatus) {
  decode.then(decode.string, fn(s) {
    case s {
      ...
      "INACCESSIBLE_ENCRYPTION_CREDENTIALS" -> decode.success(TableStatusInaccessibleEncryptionCredentials)
      "REPLICATION_NOT_AUTHORIZED" -> decode.success(TableStatusReplicationNotAuthorized)
...
pub fn decode_create_table_input_struct() -> decode.Decoder(CreateTableInput) {
  ...
  use global_table_settings_replication_mode <- decode.optional_field("GlobalTableSettingsReplicationMode", option.None, decode.optional(decode_global_table_settings_replication_mode_enum()))
  use global_table_source_arn <- decode.optional_field("GlobalTableSourceArn", option.None, decode.optional(decode.string))
  use key_schema <- decode.optional_field("KeySchema", option.None, decode.optional(decode.list(decode_key_schema_element_struct())))
  use local_secondary_indexes <- decode.optional_field("LocalSecondaryIndexes", option.None, decode.optional(decode.list(decode_local_secondary_index_struct())))
  ...
  use resource_policy <- decode.optional_field("ResourcePolicy", option.None, decode.optional(decode.string))
  use sse_specification <- decode.optional_field("SSESpecification", option.None, decode.optional(decode_sse_specification_struct()))
  use stream_specification <- decode.optional_field("StreamSpecification", option.None, decode.optional(decode_stream_specification_struct()))
  use table_class <- decode.optional_field("TableClass", option.None, decode.optional(decode_table_class_enum()))
  use table_name <- decode.optional_field("TableName", option.None, decode.optional(decode.string))
  use tags <- decode.optional_field("Tags", option.None, decode.optional(decode.list(decode_tag_struct())))
  use warm_throughput <- decode.optional_field("WarmThroughput", option.None, decode.optional(decode_warm_throughput_struct()))
...
pub fn decode_create_table_input_struct_params() -> decode.Decoder(CreateTableInput) {
  ...
  use local_secondary_indexes <- decode.optional_field("LocalSecondaryIndexes", option.None, decode.optional(decode.list(decode_local_secondary_index_struct_params())))
  ...
  use resource_policy <- decode.optional_field("ResourcePolicy", option.None, decode.optional(decode.string))
  use sse_specification <- decode.optional_field("SSESpecification", option.None, decode.optional(decode_sse_specification_struct_params()))
  use stream_specification <- decode.optional_field("StreamSpecification", option.None, decode.optional(decode_stream_specification_struct_params()))
  use table_class <- decode.optional_field("TableClass", option.None, decode.optional(decode_table_class_enum()))
  use table_name <- decode.optional_field("TableName", option.None, decode.optional(decode.string))
  use tags <- decode.optional_field("Tags", option.None, decode.optional(decode.list(decode_tag_struct_params())))
  use warm_throughput <- decode.optional_field("WarmThroughput", option.None, decode.optional(decode_warm_throughput_struct_params()))
  decode.success(CreateTableInput(
    attribute_definitions: attribute_definitions,
    billing_mode: billing_mode,
    deletion_protection_enabled: deletion_protection_enabled,
...
pub fn decode_scalar_attribute_type_enum() -> decode.Decoder(ScalarAttributeType) {
  decode.then(decode.string, fn(s) {
    case s {
...
pub fn decode_table_description_struct() -> decode.Decoder(TableDescription) {
  ...
  use creation_date_time <- decode.optional_field("CreationDateTime", option.None, decode.optional(json_timestamp.decoder()))
  use deletion_protection_enabled <- decode.optional_field("DeletionProtectionEnabled", option.None, decode.optional(decode.bool))
  use global_secondary_indexes <- decode.optional_field("GlobalSecondaryIndexes", option.None, decode.optional(decode.list(decode_global_secondary_index_description_struct())))
  use global_table_settings_replication_mode <- decode.optional_field("GlobalTableSettingsReplicationMode", option.None, decode.optional(decode_global_table_settings_replication_mode_enum()))
  use global_table_version <- decode.optional_field("GlobalTableVersion", option.None, decode.optional(decode.string))
  use global_table_witnesses <- decode.optional_field("GlobalTableWitnesses", option.None, decode.optional(decode.list(decode_global_table_witness_description_struct())))
  use item_count <- decode.optional_field("ItemCount", option.None, decode.optional(decode.int))
  use key_schema <- decode.optional_field("KeySchema", option.None, decode.optional(decode.list(decode_key_schema_element_struct())))
  use latest_stream_arn <- decode.optional_field("LatestStreamArn", option.None, decode.optional(decode.string))
  use latest_stream_label <- decode.optional_field("LatestStreamLabel", option.None, decode.optional(decode.string))
  use local_secondary_indexes <- decode.optional_field("LocalSecondaryIndexes", option.None, decode.optional(decode.list(decode_local_secondary_index_description_struct())))
  use multi_region_consistency <- decode.optional_field("MultiRegionConsistency", option.None, decode.optional(decode_multi_region_consistency_enum()))
  use on_demand_throughput <- decode.optional_field("OnDemandThroughput", option.None, decode.optional(decode_on_demand_throughput_struct()))
  use provisioned_throughput <- decode.optional_field("ProvisionedThroughput", option.None, decode.optional(decode_provisioned_throughput_description_struct()))
  use replicas <- decode.optional_field("Replicas", option.None, decode.optional(decode.list(decode_replica_description_struct())))
  use restore_summary <- decode.optional_field("RestoreSummary", option.None, decode.optional(decode_restore_summary_struct()))
  ...
  use table_class_summary <- decode.optional_field("TableClassSummary", option.None, decode.optional(decode_table_class_summary_struct()))
  use table_id <- decode.optional_field("TableId", option.None, decode.optional(decode.string))
  use table_name <- decode.optional_field("TableName", option.None, decode.optional(decode.string))
  use table_size_bytes <- decode.optional_field("TableSizeBytes", option.None, decode.optional(decode.int))
...
pub fn decode_table_description_struct_params() -> decode.Decoder(TableDescription) {
  ...
  use creation_date_time <- decode.optional_field("CreationDateTime", option.None, decode.optional(json_timestamp.decoder()))
  use deletion_protection_enabled <- decode.optional_field("DeletionProtectionEnabled", option.None, decode.optional(decode.bool))
  use global_secondary_indexes <- decode.optional_field("GlobalSecondaryIndexes", option.None, decode.optional(decode.list(decode_global_secondary_index_description_struct_params())))
  use global_table_settings_replication_mode <- decode.optional_field("GlobalTableSettingsReplicationMode", option.None, decode.optional(decode_global_table_settings_replication_mode_enum()))
  use global_table_version <- decode.optional_field("GlobalTableVersion", option.None, decode.optional(decode.string))
  use global_table_witnesses <- decode.optional_field("GlobalTableWitnesses", option.None, decode.optional(decode.list(decode_global_table_witness_description_struct_params())))
  use item_count <- decode.optional_field("ItemCount", option.None, decode.optional(decode.int))
  use key_schema <- decode.optional_field("KeySchema", option.None, decode.optional(decode.list(decode_key_schema_element_struct_params())))
  use latest_stream_arn <- decode.optional_field("LatestStreamArn", option.None, decode.optional(decode.string))
  use latest_stream_label <- decode.optional_field("LatestStreamLabel", option.None, decode.optional(decode.string))
  use local_secondary_indexes <- decode.optional_field("LocalSecondaryIndexes", option.None, decode.optional(decode.list(decode_local_secondary_index_description_struct_params())))
  use multi_region_consistency <- decode.optional_field("MultiRegionConsistency", option.None, decode.optional(decode_multi_region_consistency_enum()))
  use on_demand_throughput <- decode.optional_field("OnDemandThroughput", option.None, decode.optional(decode_on_demand_throughput_struct_params()))
  use provisioned_throughput <- decode.optional_field("ProvisionedThroughput", option.None, decode.optional(decode_provisioned_throughput_description_struct_params()))
  use replicas <- decode.optional_field("Replicas", option.None, decode.optional(decode.list(decode_replica_description_struct_params())))
  use restore_summary <- decode.optional_field("RestoreSummary", option.None, decode.optional(decode_restore_summary_struct_params()))
  ...
  use stream_specification <- decode.optional_field("StreamSpecification", option.None, decode.optional(decode_stream_specification_struct_params()))
  use table_arn <- decode.optional_field("TableArn", option.None, decode.optional(decode.string))
  use table_class_summary <- decode.optional_field("TableClassSummary", option.None, decode.optional(decode_table_class_summary_struct_params()))
  use table_id <- decode.optional_field("TableId", option.None, decode.optional(decode.string))
  use table_name <- decode.optional_field("TableName", option.None, decode.optional(decode.string))
  use table_size_bytes <- decode.optional_field("TableSizeBytes", option.None, decode.optional(decode.int))
  use table_status <- decode.optional_field("TableStatus", option.None, decode.optional(decode_table_status_enum()))
...
pub fn encode_multi_region_consistency_enum(v: MultiRegionConsistency) -> json.Json {
  case v {
...
pub fn decode_multi_region_consistency_enum() -> decode.Decoder(MultiRegionConsistency) {
  decode.then(decode.string, fn(s) {
    case s {
...
pub fn decode_restore_summary_struct() -> decode.Decoder(RestoreSummary) {
  ...
  use source_table_arn <- decode.optional_field("SourceTableArn", option.None, decode.optional(decode.string))
...
pub fn decode_sse_description_struct() -> decode.Decoder(SSEDescription) {
  ...
  use sse_type <- decode.optional_field("SSEType", option.None, decode.optional(decode_sse_type_enum()))
  use status <- decode.optional_field("Status", option.None, decode.optional(decode_sse_status_enum()))
...
pub fn decode_source_table_details_struct() -> decode.Decoder(SourceTableDetails) {
  ...
  use provisioned_throughput <- decode.optional_field("ProvisionedThroughput", option.None, decode.optional(decode_provisioned_throughput_struct()))
  use table_arn <- decode.optional_field("TableArn", option.None, decode.optional(decode.string))
  use table_creation_date_time <- decode.optional_field("TableCreationDateTime", option.None, decode.optional(json_timestamp.decoder()))
  use table_id <- decode.optional_field("TableId", option.None, decode.optional(decode.string))
  use table_name <- decode.optional_field("TableName", option.None, decode.optional(decode.string))
  use table_size_bytes <- decode.optional_field("TableSizeBytes", option.None, decode.optional(decode.int))
...
pub fn decode_source_table_feature_details_struct() -> decode.Decoder(SourceTableFeatureDetails) {
  ...
  use sse_description <- decode.optional_field("SSEDescription", option.None, decode.optional(decode_sse_description_struct()))
  use stream_description <- decode.optional_field("StreamDescription", option.None, decode.optional(decode_stream_specification_struct()))
...
pub fn decode_source_table_feature_details_struct_params() -> decode.Decoder(SourceTableFeatureDetails) {
  ...
  use sse_description <- decode.optional_field("SSEDescription", option.None, decode.optional(decode_sse_description_struct_params()))
  use stream_description <- decode.optional_field("StreamDescription", option.None, decode.optional(decode_stream_specification_struct_params()))
...
pub fn encode_continuous_backups_status_enum(v: ContinuousBackupsStatus) -> json.Json {
  case v {
...
pub fn decode_continuous_backups_status_enum() -> decode.Decoder(ContinuousBackupsStatus) {
  decode.then(decode.string, fn(s) {
    case s {
...
pub fn encode_point_in_time_recovery_status_enum(v: PointInTimeRecoveryStatus) -> json.Json {
  case v {
...
pub fn decode_point_in_time_recovery_status_enum() -> decode.Decoder(PointInTimeRecoveryStatus) {
  decode.then(decode.string, fn(s) {
    case s {
      "DISABLED" -> decode.success(PointInTimeRecoveryStatusDisabled)
      "ENABLED" -> decode.success(PointInTimeRecoveryStatusEnabled)
      _ -> decode.failure(PointInTimeRecoveryStatusDisabled, "unknown enum value")
    }
  })
}
...
pub fn decode_describe_contributor_insights_output_struct() -> decode.Decoder(DescribeContributorInsightsOutput) {
  ...
  use failure_exception <- decode.optional_field("FailureException", option.None, decode.optional(decode_failure_exception_struct()))
  use index_name <- decode.optional_field("IndexName", option.None, decode.optional(decode.string))
  use last_update_date_time <- decode.optional_field("LastUpdateDateTime", option.None, decode.optional(json_timestamp.decoder()))
  use table_name <- decode.optional_field("TableName", option.None, decode.optional(decode.string))
...
pub fn decode_describe_contributor_insights_output_struct_params() -> decode.Decoder(DescribeContributorInsightsOutput) {
  ...
  use contributor_insights_rule_list <- decode.optional_field("ContributorInsightsRuleList", option.None, decode.optional(decode.list(decode.string)))
  use contributor_insights_status <- decode.optional_field("ContributorInsightsStatus", option.None, decode.optional(decode_contributor_insights_status_enum()))
  use failure_exception <- decode.optional_field("FailureException", option.None, decode.optional(decode_failure_exception_struct_params()))
  use index_name <- decode.optional_field("IndexName", option.None, decode.optional(decode.string))
  use last_update_date_time <- decode.optional_field("LastUpdateDateTime", option.None, decode.optional(json_timestamp.decoder()))
  use table_name <- decode.optional_field("TableName", option.None, decode.optional(decode.string))
  decode.success(DescribeContributorInsightsOutput(
...
pub fn encode_contributor_insights_mode_enum(v: ContributorInsightsMode) -> json.Json {
  case v {
    ContributorInsightsModeAccessedAndThrottledKeys -> json.string("ACCESSED_AND_THROTTLED_KEYS")
    ContributorInsightsModeThrottledKeys -> json.string("THROTTLED_KEYS")
  }
}

pub fn decode_contributor_insights_mode_enum() -> decode.Decoder(ContributorInsightsMode) {
  decode.then(decode.string, fn(s) {
    case s {
      "ACCESSED_AND_THROTTLED_KEYS" -> decode.success(ContributorInsightsModeAccessedAndThrottledKeys)
      "THROTTLED_KEYS" -> decode.success(ContributorInsightsModeThrottledKeys)
      _ -> decode.failure(ContributorInsightsModeAccessedAndThrottledKeys, "unknown enum value")
    }
  })
}
...
pub fn encode_contributor_insights_status_enum(v: ContributorInsightsStatus) -> json.Json {
  case v {
...
pub fn decode_contributor_insights_status_enum() -> decode.Decoder(ContributorInsightsStatus) {
  decode.then(decode.string, fn(s) {
    case s {
      ...
      _ -> decode.failure(ContributorInsightsStatusDisabled, "unknown enum value")
    }
  })
}
...
pub fn encode_describe_endpoints_request_struct(_v: DescribeEndpointsRequest) -> json.Json {
  json.object([])
}
...
pub fn decode_describe_endpoints_request_struct_params() -> decode.Decoder(DescribeEndpointsRequest) {
  decode.success(DescribeEndpointsRequest)
}
...
pub fn decode_export_description_struct() -> decode.Decoder(ExportDescription) {
  ...
  use export_manifest <- decode.optional_field("ExportManifest", option.None, decode.optional(decode.string))
  ...
  use failure_code <- decode.optional_field("FailureCode", option.None, decode.optional(decode.string))
  use failure_message <- decode.optional_field("FailureMessage", option.None, decode.optional(decode.string))
  use incremental_export_specification <- decode.optional_field("IncrementalExportSpecification", option.None, decode.optional(decode_incremental_export_specification_struct()))
  use item_count <- decode.optional_field("ItemCount", option.None, decode.optional(decode.int))
  ...
  use s3_prefix <- decode.optional_field("S3Prefix", option.None, decode.optional(decode.string))
  use s3_sse_algorithm <- decode.optional_field("S3SseAlgorithm", option.None, decode.optional(decode_s3_sse_algorithm_enum()))
  use s3_sse_kms_key_id <- decode.optional_field("S3SseKmsKeyId", option.None, decode.optional(decode.string))
  use start_time <- decode.optional_field("StartTime", option.None, decode.optional(json_timestamp.decoder()))
  use table_arn <- decode.optional_field("TableArn", option.None, decode.optional(decode.string))
  use table_id <- decode.optional_field("TableId", option.None, decode.optional(decode.string))
...
pub fn decode_export_description_struct_params() -> decode.Decoder(ExportDescription) {
  ...
  use failure_code <- decode.optional_field("FailureCode", option.None, decode.optional(decode.string))
  use failure_message <- decode.optional_field("FailureMessage", option.None, decode.optional(decode.string))
  use incremental_export_specification <- decode.optional_field("IncrementalExportSpecification", option.None, decode.optional(decode_incremental_export_specification_struct_params()))
  use item_count <- decode.optional_field("ItemCount", option.None, decode.optional(decode.int))
  use s3_bucket <- decode.optional_field("S3Bucket", option.None, decode.optional(decode.string))
  use s3_bucket_owner <- decode.optional_field("S3BucketOwner", option.None, decode.optional(decode.string))
  use s3_prefix <- decode.optional_field("S3Prefix", option.None, decode.optional(decode.string))
...
pub fn decode_replica_settings_description_struct() -> decode.Decoder(ReplicaSettingsDescription) {
  ...
  use replica_provisioned_read_capacity_units <- decode.optional_field("ReplicaProvisionedReadCapacityUnits", option.None, decode.optional(decode.int))
  use replica_provisioned_write_capacity_auto_scaling_settings <- decode.optional_field("ReplicaProvisionedWriteCapacityAutoScalingSettings", option.None, decode.optional(decode_auto_scaling_settings_description_struct()))
  use replica_provisioned_write_capacity_units <- decode.optional_field("ReplicaProvisionedWriteCapacityUnits", option.None, decode.optional(decode.int))
  use replica_status <- decode.optional_field("ReplicaStatus", option.None, decode.optional(decode_replica_status_enum()))
  use replica_table_class_summary <- decode.optional_field("ReplicaTableClassSummary", option.None, decode.optional(decode_table_class_summary_struct()))
...
pub fn decode_replica_settings_description_struct_params() -> decode.Decoder(ReplicaSettingsDescription) {
  ...
  use replica_provisioned_read_capacity_units <- decode.optional_field("ReplicaProvisionedReadCapacityUnits", option.None, decode.optional(decode.int))
  use replica_provisioned_write_capacity_auto_scaling_settings <- decode.optional_field("ReplicaProvisionedWriteCapacityAutoScalingSettings", option.None, decode.optional(decode_auto_scaling_settings_description_struct_params()))
  use replica_provisioned_write_capacity_units <- decode.optional_field("ReplicaProvisionedWriteCapacityUnits", option.None, decode.optional(decode.int))
  use replica_status <- decode.optional_field("ReplicaStatus", option.None, decode.optional(decode_replica_status_enum()))
  use replica_table_class_summary <- decode.optional_field("ReplicaTableClassSummary", option.None, decode.optional(decode_table_class_summary_struct_params()))
  decode.success(ReplicaSettingsDescription(
...
pub fn decode_replica_global_secondary_index_settings_description_struct() -> decode.Decoder(ReplicaGlobalSecondaryIndexSettingsDescription) {
  ...
  use provisioned_write_capacity_auto_scaling_settings <- decode.optional_field("ProvisionedWriteCapacityAutoScalingSettings", option.None, decode.optional(decode_auto_scaling_settings_description_struct()))
...
pub fn decode_replica_global_secondary_index_settings_description_struct_params() -> decode.Decoder(ReplicaGlobalSecondaryIndexSettingsDescription) {
  ...
  use provisioned_read_capacity_units <- decode.optional_field("ProvisionedReadCapacityUnits", option.None, decode.optional(decode.int))
  use provisioned_write_capacity_auto_scaling_settings <- decode.optional_field("ProvisionedWriteCapacityAutoScalingSettings", option.None, decode.optional(decode_auto_scaling_settings_description_struct_params()))
  use provisioned_write_capacity_units <- decode.optional_field("ProvisionedWriteCapacityUnits", option.None, decode.optional(decode.int))
  decode.success(ReplicaGlobalSecondaryIndexSettingsDescription(
    index_name: index_name,
    index_status: index_status,
...
pub fn decode_auto_scaling_settings_description_struct() -> decode.Decoder(AutoScalingSettingsDescription) {
  ...
  use minimum_units <- decode.optional_field("MinimumUnits", option.None, decode.optional(decode.int))
  use scaling_policies <- decode.optional_field("ScalingPolicies", option.None, decode.optional(decode.list(decode_auto_scaling_policy_description_struct())))
...
pub fn decode_auto_scaling_settings_description_struct_params() -> decode.Decoder(AutoScalingSettingsDescription) {
  ...
  use maximum_units <- decode.optional_field("MaximumUnits", option.None, decode.optional(decode.int))
  use minimum_units <- decode.optional_field("MinimumUnits", option.None, decode.optional(decode.int))
  use scaling_policies <- decode.optional_field("ScalingPolicies", option.None, decode.optional(decode.list(decode_auto_scaling_policy_description_struct_params())))
  decode.success(AutoScalingSettingsDescription(
    auto_scaling_disabled: auto_scaling_disabled,
    auto_scaling_role_arn: auto_scaling_role_arn,
    maximum_units: maximum_units,
...
pub fn decode_auto_scaling_target_tracking_scaling_policy_configuration_description_struct() -> decode.Decoder(AutoScalingTargetTrackingScalingPolicyConfigurationDescription) {
  ...
  use target_value <- decode.optional_field("TargetValue", option.None, decode.optional(json_float.decoder()))
...
pub fn decode_import_table_description_struct() -> decode.Decoder(ImportTableDescription) {
  ...
  use end_time <- decode.optional_field("EndTime", option.None, decode.optional(json_timestamp.decoder()))
  use error_count <- decode.optional_field("ErrorCount", option.None, decode.optional(decode.int))
  use failure_code <- decode.optional_field("FailureCode", option.None, decode.optional(decode.string))
  use failure_message <- decode.optional_field("FailureMessage", option.None, decode.optional(decode.string))
  use import_arn <- decode.optional_field("ImportArn", option.None, decode.optional(decode.string))
  use import_status <- decode.optional_field("ImportStatus", option.None, decode.optional(decode_import_status_enum()))
  use imported_item_count <- decode.optional_field("ImportedItemCount", option.None, decode.optional(decode.int))
  ...
  use input_format_options <- decode.optional_field("InputFormatOptions", option.None, decode.optional(decode_input_format_options_struct()))
  use processed_item_count <- decode.optional_field("ProcessedItemCount", option.None, decode.optional(decode.int))
  use processed_size_bytes <- decode.optional_field("ProcessedSizeBytes", option.None, decode.optional(decode.int))
  use s3_bucket_source <- decode.optional_field("S3BucketSource", option.None, decode.optional(decode_s3_bucket_source_struct()))
  use start_time <- decode.optional_field("StartTime", option.None, decode.optional(json_timestamp.decoder()))
  use table_arn <- decode.optional_field("TableArn", option.None, decode.optional(decode.string))
  use table_creation_parameters <- decode.optional_field("TableCreationParameters", option.None, decode.optional(decode_table_creation_parameters_struct()))
  use table_id <- decode.optional_field("TableId", option.None, decode.optional(decode.string))
...
pub fn decode_import_table_description_struct_params() -> decode.Decoder(ImportTableDescription) {
  ...
  use input_compression_type <- decode.optional_field("InputCompressionType", option.None, decode.optional(decode_input_compression_type_enum()))
  use input_format <- decode.optional_field("InputFormat", option.None, decode.optional(decode_input_format_enum()))
  use input_format_options <- decode.optional_field("InputFormatOptions", option.None, decode.optional(decode_input_format_options_struct_params()))
  use processed_item_count <- decode.optional_field("ProcessedItemCount", option.None, decode.optional(decode.int))
  use processed_size_bytes <- decode.optional_field("ProcessedSizeBytes", option.None, decode.optional(decode.int))
  use s3_bucket_source <- decode.optional_field("S3BucketSource", option.None, decode.optional(decode_s3_bucket_source_struct_params()))
  use start_time <- decode.optional_field("StartTime", option.None, decode.optional(json_timestamp.decoder()))
  use table_arn <- decode.optional_field("TableArn", option.None, decode.optional(decode.string))
  use table_creation_parameters <- decode.optional_field("TableCreationParameters", option.None, decode.optional(decode_table_creation_parameters_struct_params()))
  use table_id <- decode.optional_field("TableId", option.None, decode.optional(decode.string))
  decode.success(ImportTableDescription(
    client_token: client_token,
    cloud_watch_log_group_arn: cloud_watch_log_group_arn,
...
pub fn encode_input_compression_type_enum(v: InputCompressionType) -> json.Json {
  case v {
...
pub fn decode_input_compression_type_enum() -> decode.Decoder(InputCompressionType) {
  decode.then(decode.string, fn(s) {
    case s {
...
pub fn encode_approximate_creation_date_time_precision_enum(v: ApproximateCreationDateTimePrecision) -> json.Json {
  case v {
    ApproximateCreationDateTimePrecisionMicrosecond -> json.string("MICROSECOND")
    ApproximateCreationDateTimePrecisionMillisecond -> json.string("MILLISECOND")
  }
}

pub fn decode_approximate_creation_date_time_precision_enum() -> decode.Decoder(ApproximateCreationDateTimePrecision) {
  decode.then(decode.string, fn(s) {
    case s {
      "MICROSECOND" -> decode.success(ApproximateCreationDateTimePrecisionMicrosecond)
      "MILLISECOND" -> decode.success(ApproximateCreationDateTimePrecisionMillisecond)
      _ -> decode.failure(ApproximateCreationDateTimePrecisionMicrosecond, "unknown enum value")
    }
  })
}
...
pub fn encode_describe_limits_input_struct(_v: DescribeLimitsInput) -> json.Json {
  json.object([])
}
...
pub fn decode_describe_limits_input_struct_params() -> decode.Decoder(DescribeLimitsInput) {
  decode.success(DescribeLimitsInput)
}
...
pub fn decode_describe_limits_output_struct() -> decode.Decoder(DescribeLimitsOutput) {
  ...
  use table_max_write_capacity_units <- decode.optional_field("TableMaxWriteCapacityUnits", option.None, decode.optional(decode.int))
...
pub fn decode_list_backups_input_struct() -> decode.Decoder(ListBackupsInput) {
  ...
  use limit <- decode.optional_field("Limit", option.None, decode.optional(decode.int))
  use table_name <- decode.optional_field("TableName", option.None, decode.optional(decode.string))
  use time_range_lower_bound <- decode.optional_field("TimeRangeLowerBound", option.None, decode.optional(json_timestamp.decoder()))
  use time_range_upper_bound <- decode.optional_field("TimeRangeUpperBound", option.None, decode.optional(json_timestamp.decoder()))
...
pub fn decode_query_input_struct() -> decode.Decoder(QueryInput) {
  ...
  use key_conditions <- decode.optional_field("KeyConditions", option.None, decode.optional(decode.dict(decode.string, decode_condition_struct())))
  use limit <- decode.optional_field("Limit", option.None, decode.optional(decode.int))
  use projection_expression <- decode.optional_field("ProjectionExpression", option.None, decode.optional(decode.string))
  use query_filter <- decode.optional_field("QueryFilter", option.None, decode.optional(decode.dict(decode.string, decode_condition_struct())))
  use return_consumed_capacity <- decode.optional_field("ReturnConsumedCapacity", option.None, decode.optional(decode_return_consumed_capacity_enum()))
  use scan_index_forward <- decode.optional_field("ScanIndexForward", option.None, decode.optional(decode.bool))
  use select <- decode.optional_field("Select", option.None, decode.optional(decode_select_enum()))
  use table_name <- decode.optional_field("TableName", option.None, decode.optional(decode.string))
...
pub fn decode_query_input_struct_params() -> decode.Decoder(QueryInput) {
  ...
  use index_name <- decode.optional_field("IndexName", option.None, decode.optional(decode.string))
  use key_condition_expression <- decode.optional_field("KeyConditionExpression", option.None, decode.optional(decode.string))
  use key_conditions <- decode.optional_field("KeyConditions", option.None, decode.optional(decode.dict(decode.string, decode_condition_struct_params())))
  use limit <- decode.optional_field("Limit", option.None, decode.optional(decode.int))
  use projection_expression <- decode.optional_field("ProjectionExpression", option.None, decode.optional(decode.string))
  use query_filter <- decode.optional_field("QueryFilter", option.None, decode.optional(decode.dict(decode.string, decode_condition_struct_params())))
  use return_consumed_capacity <- decode.optional_field("ReturnConsumedCapacity", option.None, decode.optional(decode_return_consumed_capacity_enum()))
  use scan_index_forward <- decode.optional_field("ScanIndexForward", option.None, decode.optional(decode.bool))
  use select <- decode.optional_field("Select", option.None, decode.optional(decode_select_enum()))
  use table_name <- decode.optional_field("TableName", option.None, decode.optional(decode.string))
...
pub fn decode_restore_table_from_backup_input_struct() -> decode.Decoder(RestoreTableFromBackupInput) {
  ...
  use on_demand_throughput_override <- decode.optional_field("OnDemandThroughputOverride", option.None, decode.optional(decode_on_demand_throughput_struct()))
  use provisioned_throughput_override <- decode.optional_field("ProvisionedThroughputOverride", option.None, decode.optional(decode_provisioned_throughput_struct()))
  use sse_specification_override <- decode.optional_field("SSESpecificationOverride", option.None, decode.optional(decode_sse_specification_struct()))
  use target_table_name <- decode.optional_field("TargetTableName", option.None, decode.optional(decode.string))
...
pub fn decode_restore_table_from_backup_input_struct_params() -> decode.Decoder(RestoreTableFromBackupInput) {
  ...
  use on_demand_throughput_override <- decode.optional_field("OnDemandThroughputOverride", option.None, decode.optional(decode_on_demand_throughput_struct_params()))
  use provisioned_throughput_override <- decode.optional_field("ProvisionedThroughputOverride", option.None, decode.optional(decode_provisioned_throughput_struct_params()))
  use sse_specification_override <- decode.optional_field("SSESpecificationOverride", option.None, decode.optional(decode_sse_specification_struct_params()))
  use target_table_name <- decode.optional_field("TargetTableName", option.None, decode.optional(decode.string))
  decode.success(RestoreTableFromBackupInput(
    backup_arn: backup_arn,
    billing_mode_override: billing_mode_override,
...
pub fn decode_restore_table_to_point_in_time_input_struct() -> decode.Decoder(RestoreTableToPointInTimeInput) {
  ...
  use sse_specification_override <- decode.optional_field("SSESpecificationOverride", option.None, decode.optional(decode_sse_specification_struct()))
  use source_table_arn <- decode.optional_field("SourceTableArn", option.None, decode.optional(decode.string))
  use source_table_name <- decode.optional_field("SourceTableName", option.None, decode.optional(decode.string))
  use target_table_name <- decode.optional_field("TargetTableName", option.None, decode.optional(decode.string))
  use use_latest_restorable_time <- decode.optional_field("UseLatestRestorableTime", option.None, decode.optional(decode.bool))
...
pub fn decode_scan_input_struct() -> decode.Decoder(ScanInput) {
  ...
  use projection_expression <- decode.optional_field("ProjectionExpression", option.None, decode.optional(decode.string))
  use return_consumed_capacity <- decode.optional_field("ReturnConsumedCapacity", option.None, decode.optional(decode_return_consumed_capacity_enum()))
  use scan_filter <- decode.optional_field("ScanFilter", option.None, decode.optional(decode.dict(decode.string, decode_condition_struct())))
  use segment <- decode.optional_field("Segment", option.None, decode.optional(decode.int))
  use select <- decode.optional_field("Select", option.None, decode.optional(decode_select_enum()))
  use table_name <- decode.optional_field("TableName", option.None, decode.optional(decode.string))
  use total_segments <- decode.optional_field("TotalSegments", option.None, decode.optional(decode.int))
...
pub fn decode_scan_input_struct_params() -> decode.Decoder(ScanInput) {
  ...
  use projection_expression <- decode.optional_field("ProjectionExpression", option.None, decode.optional(decode.string))
  use return_consumed_capacity <- decode.optional_field("ReturnConsumedCapacity", option.None, decode.optional(decode_return_consumed_capacity_enum()))
  use scan_filter <- decode.optional_field("ScanFilter", option.None, decode.optional(decode.dict(decode.string, decode_condition_struct_params())))
  use segment <- decode.optional_field("Segment", option.None, decode.optional(decode.int))
  use select <- decode.optional_field("Select", option.None, decode.optional(decode_select_enum()))
  use table_name <- decode.optional_field("TableName", option.None, decode.optional(decode.string))
  use total_segments <- decode.optional_field("TotalSegments", option.None, decode.optional(decode.int))
...
pub fn decode_transact_write_items_input_struct() -> decode.Decoder(TransactWriteItemsInput) {
  ...
  use return_consumed_capacity <- decode.optional_field("ReturnConsumedCapacity", option.None, decode.optional(decode_return_consumed_capacity_enum()))
  use return_item_collection_metrics <- decode.optional_field("ReturnItemCollectionMetrics", option.None, decode.optional(decode_return_item_collection_metrics_enum()))
  use transact_items <- decode.optional_field("TransactItems", option.None, decode.optional(decode.list(decode_transact_write_item_struct())))
...
pub fn decode_transact_write_items_input_struct_params() -> decode.Decoder(TransactWriteItemsInput) {
  ...
  use return_consumed_capacity <- decode.optional_field("ReturnConsumedCapacity", option.None, decode.optional(decode_return_consumed_capacity_enum()))
  use return_item_collection_metrics <- decode.optional_field("ReturnItemCollectionMetrics", option.None, decode.optional(decode_return_item_collection_metrics_enum()))
  use transact_items <- decode.optional_field("TransactItems", option.None, decode.optional(decode.list(decode_transact_write_item_struct_params())))
  decode.success(TransactWriteItemsInput(
    client_request_token: client_request_token,
    return_consumed_capacity: return_consumed_capacity,
    return_item_collection_metrics: return_item_collection_metrics,
...
pub fn decode_transact_write_item_struct() -> decode.Decoder(TransactWriteItem) {
  ...
  use update <- decode.optional_field("Update", option.None, decode.optional(decode_update_struct()))
...
pub fn decode_transact_write_item_struct_params() -> decode.Decoder(TransactWriteItem) {
  ...
  use update <- decode.optional_field("Update", option.None, decode.optional(decode_update_struct_params()))
  decode.success(TransactWriteItem(
    condition_check: condition_check,
    delete: delete,
    put: put,
...
pub fn encode_contributor_insights_action_enum(v: ContributorInsightsAction) -> json.Json {
  case v {
...
pub fn decode_contributor_insights_action_enum() -> decode.Decoder(ContributorInsightsAction) {
  decode.then(decode.string, fn(s) {
    case s {
      "DISABLE" -> decode.success(ContributorInsightsActionDisable)
      "ENABLE" -> decode.success(ContributorInsightsActionEnable)
      _ -> decode.failure(ContributorInsightsActionDisable, "unknown enum value")
    }
  })
}
...
pub fn decode_update_global_table_settings_input_struct() -> decode.Decoder(UpdateGlobalTableSettingsInput) {
  ...
  use global_table_name <- decode.optional_field("GlobalTableName", option.None, decode.optional(decode.string))
  use global_table_provisioned_write_capacity_auto_scaling_settings_update <- decode.optional_field("GlobalTableProvisionedWriteCapacityAutoScalingSettingsUpdate", option.None, decode.optional(decode_auto_scaling_settings_update_struct()))
  use global_table_provisioned_write_capacity_units <- decode.optional_field("GlobalTableProvisionedWriteCapacityUnits", option.None, decode.optional(decode.int))
  use replica_settings_update <- decode.optional_field("ReplicaSettingsUpdate", option.None, decode.optional(decode.list(decode_replica_settings_update_struct())))
...
pub fn decode_update_global_table_settings_input_struct_params() -> decode.Decoder(UpdateGlobalTableSettingsInput) {
  ...
  use global_table_name <- decode.optional_field("GlobalTableName", option.None, decode.optional(decode.string))
  use global_table_provisioned_write_capacity_auto_scaling_settings_update <- decode.optional_field("GlobalTableProvisionedWriteCapacityAutoScalingSettingsUpdate", option.None, decode.optional(decode_auto_scaling_settings_update_struct_params()))
  use global_table_provisioned_write_capacity_units <- decode.optional_field("GlobalTableProvisionedWriteCapacityUnits", option.None, decode.optional(decode.int))
  use replica_settings_update <- decode.optional_field("ReplicaSettingsUpdate", option.None, decode.optional(decode.list(decode_replica_settings_update_struct_params())))
  decode.success(UpdateGlobalTableSettingsInput(
    global_table_billing_mode: global_table_billing_mode,
    global_table_global_secondary_index_settings_update: global_table_global_secondary_index_settings_update,
    global_table_name: global_table_name,
...
pub fn decode_auto_scaling_settings_update_struct() -> decode.Decoder(AutoScalingSettingsUpdate) {
  ...
  use maximum_units <- decode.optional_field("MaximumUnits", option.None, decode.optional(decode.int))
  use minimum_units <- decode.optional_field("MinimumUnits", option.None, decode.optional(decode.int))
  use scaling_policy_update <- decode.optional_field("ScalingPolicyUpdate", option.None, decode.optional(decode_auto_scaling_policy_update_struct()))
...
pub fn decode_auto_scaling_settings_update_struct_params() -> decode.Decoder(AutoScalingSettingsUpdate) {
  ...
  use maximum_units <- decode.optional_field("MaximumUnits", option.None, decode.optional(decode.int))
  use minimum_units <- decode.optional_field("MinimumUnits", option.None, decode.optional(decode.int))
  use scaling_policy_update <- decode.optional_field("ScalingPolicyUpdate", option.None, decode.optional(decode_auto_scaling_policy_update_struct_params()))
  decode.success(AutoScalingSettingsUpdate(
    auto_scaling_disabled: auto_scaling_disabled,
    auto_scaling_role_arn: auto_scaling_role_arn,
    maximum_units: maximum_units,
...
pub fn decode_replica_settings_update_struct() -> decode.Decoder(ReplicaSettingsUpdate) {
  ...
  use replica_provisioned_read_capacity_units <- decode.optional_field("ReplicaProvisionedReadCapacityUnits", option.None, decode.optional(decode.int))
  use replica_table_class <- decode.optional_field("ReplicaTableClass", option.None, decode.optional(decode_table_class_enum()))
...
pub fn decode_update_table_input_struct() -> decode.Decoder(UpdateTableInput) {
  ...
  use billing_mode <- decode.optional_field("BillingMode", option.None, decode.optional(decode_billing_mode_enum()))
  use deletion_protection_enabled <- decode.optional_field("DeletionProtectionEnabled", option.None, decode.optional(decode.bool))
  use global_secondary_index_updates <- decode.optional_field("GlobalSecondaryIndexUpdates", option.None, decode.optional(decode.list(decode_global_secondary_index_update_struct())))
  use global_table_settings_replication_mode <- decode.optional_field("GlobalTableSettingsReplicationMode", option.None, decode.optional(decode_global_table_settings_replication_mode_enum()))
  use global_table_witness_updates <- decode.optional_field("GlobalTableWitnessUpdates", option.None, decode.optional(decode.list(decode_global_table_witness_group_update_struct())))
  use multi_region_consistency <- decode.optional_field("MultiRegionConsistency", option.None, decode.optional(decode_multi_region_consistency_enum()))
  use on_demand_throughput <- decode.optional_field("OnDemandThroughput", option.None, decode.optional(decode_on_demand_throughput_struct()))
  use provisioned_throughput <- decode.optional_field("ProvisionedThroughput", option.None, decode.optional(decode_provisioned_throughput_struct()))
  use replica_updates <- decode.optional_field("ReplicaUpdates", option.None, decode.optional(decode.list(decode_replication_group_update_struct())))
  use sse_specification <- decode.optional_field("SSESpecification", option.None, decode.optional(decode_sse_specification_struct()))
  use stream_specification <- decode.optional_field("StreamSpecification", option.None, decode.optional(decode_stream_specification_struct()))
  use table_class <- decode.optional_field("TableClass", option.None, decode.optional(decode_table_class_enum()))
  use table_name <- decode.optional_field("TableName", option.None, decode.optional(decode.string))
...
pub fn decode_update_table_input_struct_params() -> decode.Decoder(UpdateTableInput) {
  ...
  use billing_mode <- decode.optional_field("BillingMode", option.None, decode.optional(decode_billing_mode_enum()))
  use deletion_protection_enabled <- decode.optional_field("DeletionProtectionEnabled", option.None, decode.optional(decode.bool))
  use global_secondary_index_updates <- decode.optional_field("GlobalSecondaryIndexUpdates", option.None, decode.optional(decode.list(decode_global_secondary_index_update_struct_params())))
  use global_table_settings_replication_mode <- decode.optional_field("GlobalTableSettingsReplicationMode", option.None, decode.optional(decode_global_table_settings_replication_mode_enum()))
  use global_table_witness_updates <- decode.optional_field("GlobalTableWitnessUpdates", option.None, decode.optional(decode.list(decode_global_table_witness_group_update_struct_params())))
  use multi_region_consistency <- decode.optional_field("MultiRegionConsistency", option.None, decode.optional(decode_multi_region_consistency_enum()))
  use on_demand_throughput <- decode.optional_field("OnDemandThroughput", option.None, decode.optional(decode_on_demand_throughput_struct_params()))
  use provisioned_throughput <- decode.optional_field("ProvisionedThroughput", option.None, decode.optional(decode_provisioned_throughput_struct_params()))
  use replica_updates <- decode.optional_field("ReplicaUpdates", option.None, decode.optional(decode.list(decode_replication_group_update_struct_params())))
  use sse_specification <- decode.optional_field("SSESpecification", option.None, decode.optional(decode_sse_specification_struct_params()))
  use stream_specification <- decode.optional_field("StreamSpecification", option.None, decode.optional(decode_stream_specification_struct_params()))
  use table_class <- decode.optional_field("TableClass", option.None, decode.optional(decode_table_class_enum()))
  use table_name <- decode.optional_field("TableName", option.None, decode.optional(decode.string))
...
pub fn decode_create_replication_group_member_action_struct() -> decode.Decoder(CreateReplicationGroupMemberAction) {
  ...
  use provisioned_throughput_override <- decode.optional_field("ProvisionedThroughputOverride", option.None, decode.optional(decode_provisioned_throughput_override_struct()))
  use region_name <- decode.optional_field("RegionName", option.None, decode.optional(decode.string))
  use table_class_override <- decode.optional_field("TableClassOverride", option.None, decode.optional(decode_table_class_enum()))
...
pub fn decode_batch_execute_statement_input(body: String) -> Result(BatchExecuteStatementInput, String) {
  case json.parse(body, decode_batch_execute_statement_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}

pub fn decode_batch_execute_statement_output(body: String) -> Result(BatchExecuteStatementOutput, String) {
...
fn translate_batch_execute_statement_error(err: awsjson_client.ClientError) -> BatchExecuteStatementError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
        case awsjson_client.error_type_matches(et, "InternalServerError") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_internal_server_error_struct()) {
              Ok(v) -> BatchExecuteStatementErrorInternalServerError(value: v)
              Error(_) -> BatchExecuteStatementErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> BatchExecuteStatementErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "RequestLimitExceeded") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_request_limit_exceeded_struct()) {
              Ok(v) -> BatchExecuteStatementErrorRequestLimitExceeded(value: v)
              Error(_) -> BatchExecuteStatementErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> BatchExecuteStatementErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "ThrottlingException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_throttling_exception_struct()) {
              Ok(v) -> BatchExecuteStatementErrorThrottlingException(value: v)
              Error(_) -> BatchExecuteStatementErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> BatchExecuteStatementErrorUnknown(error_type: et, status: s, body: "")
          }
          False -> case bit_array.to_string(b) {
          Ok(text) -> BatchExecuteStatementErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> BatchExecuteStatementErrorUnknown(error_type: et, status: s, body: "")
        }
        }
        }
    ...
    awsjson_client.TransportError(_) -> BatchExecuteStatementErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> BatchExecuteStatementErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> BatchExecuteStatementErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn decode_batch_get_item_input(body: String) -> Result(BatchGetItemInput, String) {
  case json.parse(body, decode_batch_get_item_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}

pub fn decode_batch_get_item_output(body: String) -> Result(BatchGetItemOutput, String) {
...
fn translate_batch_get_item_error(err: awsjson_client.ClientError) -> BatchGetItemError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
        case awsjson_client.error_type_matches(et, "InternalServerError") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_internal_server_error_struct()) {
              Ok(v) -> BatchGetItemErrorInternalServerError(value: v)
              Error(_) -> BatchGetItemErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> BatchGetItemErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "InvalidEndpointException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_invalid_endpoint_exception_struct()) {
              Ok(v) -> BatchGetItemErrorInvalidEndpointException(value: v)
              Error(_) -> BatchGetItemErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> BatchGetItemErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "ProvisionedThroughputExceededException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_provisioned_throughput_exceeded_exception_struct()) {
              Ok(v) -> BatchGetItemErrorProvisionedThroughputExceededException(value: v)
              Error(_) -> BatchGetItemErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> BatchGetItemErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_request_limit_exceeded_struct()) {
              Ok(v) -> BatchGetItemErrorRequestLimitExceeded(value: v)
              Error(_) -> BatchGetItemErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> BatchGetItemErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "ResourceNotFoundException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_resource_not_found_exception_struct()) {
              Ok(v) -> BatchGetItemErrorResourceNotFoundException(value: v)
              Error(_) -> BatchGetItemErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> BatchGetItemErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_throttling_exception_struct()) {
              Ok(v) -> BatchGetItemErrorThrottlingException(value: v)
              Error(_) -> BatchGetItemErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> BatchGetItemErrorUnknown(error_type: et, status: s, body: "")
          }
          False -> case bit_array.to_string(b) {
          Ok(text) -> BatchGetItemErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> BatchGetItemErrorUnknown(error_type: et, status: s, body: "")
        }
        }
        }
    ...
    awsjson_client.TransportError(_) -> BatchGetItemErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> BatchGetItemErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> BatchGetItemErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn decode_batch_write_item_input(body: String) -> Result(BatchWriteItemInput, String) {
  case json.parse(body, decode_batch_write_item_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}

pub fn decode_batch_write_item_output(body: String) -> Result(BatchWriteItemOutput, String) {
...
fn translate_batch_write_item_error(err: awsjson_client.ClientError) -> BatchWriteItemError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
        case awsjson_client.error_type_matches(et, "InternalServerError") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_internal_server_error_struct()) {
              Ok(v) -> BatchWriteItemErrorInternalServerError(value: v)
              Error(_) -> BatchWriteItemErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> BatchWriteItemErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "InvalidEndpointException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_invalid_endpoint_exception_struct()) {
              Ok(v) -> BatchWriteItemErrorInvalidEndpointException(value: v)
              Error(_) -> BatchWriteItemErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> BatchWriteItemErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "ItemCollectionSizeLimitExceededException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_item_collection_size_limit_exceeded_exception_struct()) {
              Ok(v) -> BatchWriteItemErrorItemCollectionSizeLimitExceededException(value: v)
              Error(_) -> BatchWriteItemErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> BatchWriteItemErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_provisioned_throughput_exceeded_exception_struct()) {
              Ok(v) -> BatchWriteItemErrorProvisionedThroughputExceededException(value: v)
              Error(_) -> BatchWriteItemErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> BatchWriteItemErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "ReplicatedWriteConflictException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_replicated_write_conflict_exception_struct()) {
              Ok(v) -> BatchWriteItemErrorReplicatedWriteConflictException(value: v)
              Error(_) -> BatchWriteItemErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> BatchWriteItemErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_request_limit_exceeded_struct()) {
              Ok(v) -> BatchWriteItemErrorRequestLimitExceeded(value: v)
              Error(_) -> BatchWriteItemErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> BatchWriteItemErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_resource_not_found_exception_struct()) {
              Ok(v) -> BatchWriteItemErrorResourceNotFoundException(value: v)
              Error(_) -> BatchWriteItemErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> BatchWriteItemErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_throttling_exception_struct()) {
              Ok(v) -> BatchWriteItemErrorThrottlingException(value: v)
              Error(_) -> BatchWriteItemErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> BatchWriteItemErrorUnknown(error_type: et, status: s, body: "")
          }
          False -> case bit_array.to_string(b) {
          Ok(text) -> BatchWriteItemErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> BatchWriteItemErrorUnknown(error_type: et, status: s, body: "")
        }
        }
        }
    ...
    awsjson_client.TransportError(_) -> BatchWriteItemErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> BatchWriteItemErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> BatchWriteItemErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn decode_create_backup_input(body: String) -> Result(CreateBackupInput, String) {
  case json.parse(body, decode_create_backup_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}

pub fn decode_create_backup_output(body: String) -> Result(CreateBackupOutput, String) {
...
fn translate_create_backup_error(err: awsjson_client.ClientError) -> CreateBackupError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
        case awsjson_client.error_type_matches(et, "BackupInUseException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_backup_in_use_exception_struct()) {
              Ok(v) -> CreateBackupErrorBackupInUseException(value: v)
              Error(_) -> CreateBackupErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> CreateBackupErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "ContinuousBackupsUnavailableException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_continuous_backups_unavailable_exception_struct()) {
              Ok(v) -> CreateBackupErrorContinuousBackupsUnavailableException(value: v)
              Error(_) -> CreateBackupErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> CreateBackupErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "InternalServerError") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_internal_server_error_struct()) {
              Ok(v) -> CreateBackupErrorInternalServerError(value: v)
              Error(_) -> CreateBackupErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> CreateBackupErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_invalid_endpoint_exception_struct()) {
              Ok(v) -> CreateBackupErrorInvalidEndpointException(value: v)
              Error(_) -> CreateBackupErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> CreateBackupErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "LimitExceededException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_limit_exceeded_exception_struct()) {
              Ok(v) -> CreateBackupErrorLimitExceededException(value: v)
              Error(_) -> CreateBackupErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> CreateBackupErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "TableInUseException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_table_in_use_exception_struct()) {
              Ok(v) -> CreateBackupErrorTableInUseException(value: v)
              Error(_) -> CreateBackupErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> CreateBackupErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "TableNotFoundException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_table_not_found_exception_struct()) {
              Ok(v) -> CreateBackupErrorTableNotFoundException(value: v)
              Error(_) -> CreateBackupErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> CreateBackupErrorUnknown(error_type: et, status: s, body: "")
          }
          False -> case bit_array.to_string(b) {
          Ok(text) -> CreateBackupErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> CreateBackupErrorUnknown(error_type: et, status: s, body: "")
        }
        }
        }
    ...
    awsjson_client.TransportError(_) -> CreateBackupErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> CreateBackupErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> CreateBackupErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn decode_create_global_table_input(body: String) -> Result(CreateGlobalTableInput, String) {
  case json.parse(body, decode_create_global_table_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}

pub fn decode_create_global_table_output(body: String) -> Result(CreateGlobalTableOutput, String) {
...
fn translate_create_global_table_error(err: awsjson_client.ClientError) -> CreateGlobalTableError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
        case awsjson_client.error_type_matches(et, "GlobalTableAlreadyExistsException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_global_table_already_exists_exception_struct()) {
              Ok(v) -> CreateGlobalTableErrorGlobalTableAlreadyExistsException(value: v)
              Error(_) -> CreateGlobalTableErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> CreateGlobalTableErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "InternalServerError") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_internal_server_error_struct()) {
              Ok(v) -> CreateGlobalTableErrorInternalServerError(value: v)
              Error(_) -> CreateGlobalTableErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> CreateGlobalTableErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_invalid_endpoint_exception_struct()) {
              Ok(v) -> CreateGlobalTableErrorInvalidEndpointException(value: v)
              Error(_) -> CreateGlobalTableErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> CreateGlobalTableErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_limit_exceeded_exception_struct()) {
              Ok(v) -> CreateGlobalTableErrorLimitExceededException(value: v)
              Error(_) -> CreateGlobalTableErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> CreateGlobalTableErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_table_not_found_exception_struct()) {
              Ok(v) -> CreateGlobalTableErrorTableNotFoundException(value: v)
              Error(_) -> CreateGlobalTableErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> CreateGlobalTableErrorUnknown(error_type: et, status: s, body: "")
          }
          False -> case bit_array.to_string(b) {
          Ok(text) -> CreateGlobalTableErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> CreateGlobalTableErrorUnknown(error_type: et, status: s, body: "")
        }
        }
        }
    ...
    awsjson_client.TransportError(_) -> CreateGlobalTableErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> CreateGlobalTableErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> CreateGlobalTableErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn decode_create_table_input(body: String) -> Result(CreateTableInput, String) {
  case json.parse(body, decode_create_table_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}

pub fn decode_create_table_output(body: String) -> Result(CreateTableOutput, String) {
...
fn translate_create_table_error(err: awsjson_client.ClientError) -> CreateTableError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
        case awsjson_client.error_type_matches(et, "InternalServerError") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_internal_server_error_struct()) {
              Ok(v) -> CreateTableErrorInternalServerError(value: v)
              Error(_) -> CreateTableErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> CreateTableErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "InvalidEndpointException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_invalid_endpoint_exception_struct()) {
              Ok(v) -> CreateTableErrorInvalidEndpointException(value: v)
              Error(_) -> CreateTableErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> CreateTableErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_limit_exceeded_exception_struct()) {
              Ok(v) -> CreateTableErrorLimitExceededException(value: v)
              Error(_) -> CreateTableErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> CreateTableErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "ResourceInUseException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_resource_in_use_exception_struct()) {
              Ok(v) -> CreateTableErrorResourceInUseException(value: v)
              Error(_) -> CreateTableErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> CreateTableErrorUnknown(error_type: et, status: s, body: "")
          }
          False -> case bit_array.to_string(b) {
          Ok(text) -> CreateTableErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> CreateTableErrorUnknown(error_type: et, status: s, body: "")
        }
        }
        }
    ...
    awsjson_client.TransportError(_) -> CreateTableErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> CreateTableErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> CreateTableErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn decode_delete_backup_input(body: String) -> Result(DeleteBackupInput, String) {
  case json.parse(body, decode_delete_backup_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}

pub fn decode_delete_backup_output(body: String) -> Result(DeleteBackupOutput, String) {
...
fn translate_delete_backup_error(err: awsjson_client.ClientError) -> DeleteBackupError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
        case awsjson_client.error_type_matches(et, "BackupInUseException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_backup_in_use_exception_struct()) {
              Ok(v) -> DeleteBackupErrorBackupInUseException(value: v)
              Error(_) -> DeleteBackupErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DeleteBackupErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "BackupNotFoundException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_backup_not_found_exception_struct()) {
              Ok(v) -> DeleteBackupErrorBackupNotFoundException(value: v)
              Error(_) -> DeleteBackupErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DeleteBackupErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_internal_server_error_struct()) {
              Ok(v) -> DeleteBackupErrorInternalServerError(value: v)
              Error(_) -> DeleteBackupErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DeleteBackupErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_invalid_endpoint_exception_struct()) {
              Ok(v) -> DeleteBackupErrorInvalidEndpointException(value: v)
              Error(_) -> DeleteBackupErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DeleteBackupErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_limit_exceeded_exception_struct()) {
              Ok(v) -> DeleteBackupErrorLimitExceededException(value: v)
              Error(_) -> DeleteBackupErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DeleteBackupErrorUnknown(error_type: et, status: s, body: "")
          }
          False -> case bit_array.to_string(b) {
          Ok(text) -> DeleteBackupErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> DeleteBackupErrorUnknown(error_type: et, status: s, body: "")
        }
        }
        }
    ...
    awsjson_client.TransportError(_) -> DeleteBackupErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> DeleteBackupErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> DeleteBackupErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn decode_delete_item_input(body: String) -> Result(DeleteItemInput, String) {
  case json.parse(body, decode_delete_item_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}

pub fn decode_delete_item_output(body: String) -> Result(DeleteItemOutput, String) {
...
fn translate_delete_item_error(err: awsjson_client.ClientError) -> DeleteItemError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
        case awsjson_client.error_type_matches(et, "ConditionalCheckFailedException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_conditional_check_failed_exception_struct()) {
              Ok(v) -> DeleteItemErrorConditionalCheckFailedException(value: v)
              Error(_) -> DeleteItemErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DeleteItemErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "InternalServerError") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_internal_server_error_struct()) {
              Ok(v) -> DeleteItemErrorInternalServerError(value: v)
              Error(_) -> DeleteItemErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DeleteItemErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_invalid_endpoint_exception_struct()) {
              Ok(v) -> DeleteItemErrorInvalidEndpointException(value: v)
              Error(_) -> DeleteItemErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DeleteItemErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_item_collection_size_limit_exceeded_exception_struct()) {
              Ok(v) -> DeleteItemErrorItemCollectionSizeLimitExceededException(value: v)
              Error(_) -> DeleteItemErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DeleteItemErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_provisioned_throughput_exceeded_exception_struct()) {
              Ok(v) -> DeleteItemErrorProvisionedThroughputExceededException(value: v)
              Error(_) -> DeleteItemErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DeleteItemErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_replicated_write_conflict_exception_struct()) {
              Ok(v) -> DeleteItemErrorReplicatedWriteConflictException(value: v)
              Error(_) -> DeleteItemErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DeleteItemErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_request_limit_exceeded_struct()) {
              Ok(v) -> DeleteItemErrorRequestLimitExceeded(value: v)
              Error(_) -> DeleteItemErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DeleteItemErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_resource_not_found_exception_struct()) {
              Ok(v) -> DeleteItemErrorResourceNotFoundException(value: v)
              Error(_) -> DeleteItemErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DeleteItemErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_throttling_exception_struct()) {
              Ok(v) -> DeleteItemErrorThrottlingException(value: v)
              Error(_) -> DeleteItemErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DeleteItemErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "TransactionConflictException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_transaction_conflict_exception_struct()) {
              Ok(v) -> DeleteItemErrorTransactionConflictException(value: v)
              Error(_) -> DeleteItemErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DeleteItemErrorUnknown(error_type: et, status: s, body: "")
          }
          False -> case bit_array.to_string(b) {
          Ok(text) -> DeleteItemErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> DeleteItemErrorUnknown(error_type: et, status: s, body: "")
        }
        }
        }
    ...
    awsjson_client.TransportError(_) -> DeleteItemErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> DeleteItemErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> DeleteItemErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn decode_delete_resource_policy_input(body: String) -> Result(DeleteResourcePolicyInput, String) {
  case json.parse(body, decode_delete_resource_policy_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}

pub fn decode_delete_resource_policy_output(body: String) -> Result(DeleteResourcePolicyOutput, String) {
...
fn translate_delete_resource_policy_error(err: awsjson_client.ClientError) -> DeleteResourcePolicyError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
        case awsjson_client.error_type_matches(et, "InternalServerError") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_internal_server_error_struct()) {
              Ok(v) -> DeleteResourcePolicyErrorInternalServerError(value: v)
              Error(_) -> DeleteResourcePolicyErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DeleteResourcePolicyErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "InvalidEndpointException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_invalid_endpoint_exception_struct()) {
              Ok(v) -> DeleteResourcePolicyErrorInvalidEndpointException(value: v)
              Error(_) -> DeleteResourcePolicyErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DeleteResourcePolicyErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_limit_exceeded_exception_struct()) {
              Ok(v) -> DeleteResourcePolicyErrorLimitExceededException(value: v)
              Error(_) -> DeleteResourcePolicyErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DeleteResourcePolicyErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "PolicyNotFoundException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_policy_not_found_exception_struct()) {
              Ok(v) -> DeleteResourcePolicyErrorPolicyNotFoundException(value: v)
              Error(_) -> DeleteResourcePolicyErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DeleteResourcePolicyErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_resource_in_use_exception_struct()) {
              Ok(v) -> DeleteResourcePolicyErrorResourceInUseException(value: v)
              Error(_) -> DeleteResourcePolicyErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DeleteResourcePolicyErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_resource_not_found_exception_struct()) {
              Ok(v) -> DeleteResourcePolicyErrorResourceNotFoundException(value: v)
              Error(_) -> DeleteResourcePolicyErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DeleteResourcePolicyErrorUnknown(error_type: et, status: s, body: "")
          }
          False -> case bit_array.to_string(b) {
          Ok(text) -> DeleteResourcePolicyErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> DeleteResourcePolicyErrorUnknown(error_type: et, status: s, body: "")
        }
        }
        }
    ...
    awsjson_client.TransportError(_) -> DeleteResourcePolicyErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> DeleteResourcePolicyErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> DeleteResourcePolicyErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn decode_delete_table_input(body: String) -> Result(DeleteTableInput, String) {
  case json.parse(body, decode_delete_table_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}

pub fn decode_delete_table_output(body: String) -> Result(DeleteTableOutput, String) {
...
fn translate_delete_table_error(err: awsjson_client.ClientError) -> DeleteTableError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
        case awsjson_client.error_type_matches(et, "InternalServerError") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_internal_server_error_struct()) {
              Ok(v) -> DeleteTableErrorInternalServerError(value: v)
              Error(_) -> DeleteTableErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DeleteTableErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "InvalidEndpointException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_invalid_endpoint_exception_struct()) {
              Ok(v) -> DeleteTableErrorInvalidEndpointException(value: v)
              Error(_) -> DeleteTableErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DeleteTableErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_limit_exceeded_exception_struct()) {
              Ok(v) -> DeleteTableErrorLimitExceededException(value: v)
              Error(_) -> DeleteTableErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DeleteTableErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_resource_in_use_exception_struct()) {
              Ok(v) -> DeleteTableErrorResourceInUseException(value: v)
              Error(_) -> DeleteTableErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DeleteTableErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_resource_not_found_exception_struct()) {
              Ok(v) -> DeleteTableErrorResourceNotFoundException(value: v)
              Error(_) -> DeleteTableErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DeleteTableErrorUnknown(error_type: et, status: s, body: "")
          }
          False -> case bit_array.to_string(b) {
          Ok(text) -> DeleteTableErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> DeleteTableErrorUnknown(error_type: et, status: s, body: "")
        }
        }
        }
    ...
    awsjson_client.TransportError(_) -> DeleteTableErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> DeleteTableErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> DeleteTableErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn decode_describe_backup_input(body: String) -> Result(DescribeBackupInput, String) {
  case json.parse(body, decode_describe_backup_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}

pub fn decode_describe_backup_output(body: String) -> Result(DescribeBackupOutput, String) {
...
fn translate_describe_backup_error(err: awsjson_client.ClientError) -> DescribeBackupError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
        case awsjson_client.error_type_matches(et, "BackupNotFoundException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_backup_not_found_exception_struct()) {
              Ok(v) -> DescribeBackupErrorBackupNotFoundException(value: v)
              Error(_) -> DescribeBackupErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DescribeBackupErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "InternalServerError") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_internal_server_error_struct()) {
              Ok(v) -> DescribeBackupErrorInternalServerError(value: v)
              Error(_) -> DescribeBackupErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DescribeBackupErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_invalid_endpoint_exception_struct()) {
              Ok(v) -> DescribeBackupErrorInvalidEndpointException(value: v)
              Error(_) -> DescribeBackupErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DescribeBackupErrorUnknown(error_type: et, status: s, body: "")
          }
          False -> case bit_array.to_string(b) {
          Ok(text) -> DescribeBackupErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> DescribeBackupErrorUnknown(error_type: et, status: s, body: "")
        }
        }
        }
    ...
    awsjson_client.TransportError(_) -> DescribeBackupErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> DescribeBackupErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> DescribeBackupErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn decode_describe_continuous_backups_input(body: String) -> Result(DescribeContinuousBackupsInput, String) {
  case json.parse(body, decode_describe_continuous_backups_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}

pub fn decode_describe_continuous_backups_output(body: String) -> Result(DescribeContinuousBackupsOutput, String) {
...
fn translate_describe_continuous_backups_error(err: awsjson_client.ClientError) -> DescribeContinuousBackupsError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
        case awsjson_client.error_type_matches(et, "InternalServerError") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_internal_server_error_struct()) {
              Ok(v) -> DescribeContinuousBackupsErrorInternalServerError(value: v)
              Error(_) -> DescribeContinuousBackupsErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DescribeContinuousBackupsErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "InvalidEndpointException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_invalid_endpoint_exception_struct()) {
              Ok(v) -> DescribeContinuousBackupsErrorInvalidEndpointException(value: v)
              Error(_) -> DescribeContinuousBackupsErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DescribeContinuousBackupsErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_table_not_found_exception_struct()) {
              Ok(v) -> DescribeContinuousBackupsErrorTableNotFoundException(value: v)
              Error(_) -> DescribeContinuousBackupsErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DescribeContinuousBackupsErrorUnknown(error_type: et, status: s, body: "")
          }
          False -> case bit_array.to_string(b) {
          Ok(text) -> DescribeContinuousBackupsErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> DescribeContinuousBackupsErrorUnknown(error_type: et, status: s, body: "")
        }
        }
        }
    ...
    awsjson_client.TransportError(_) -> DescribeContinuousBackupsErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> DescribeContinuousBackupsErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> DescribeContinuousBackupsErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn decode_describe_contributor_insights_input(body: String) -> Result(DescribeContributorInsightsInput, String) {
  case json.parse(body, decode_describe_contributor_insights_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}

pub fn decode_describe_contributor_insights_output(body: String) -> Result(DescribeContributorInsightsOutput, String) {
...
fn translate_describe_contributor_insights_error(err: awsjson_client.ClientError) -> DescribeContributorInsightsError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
        case awsjson_client.error_type_matches(et, "InternalServerError") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_internal_server_error_struct()) {
              Ok(v) -> DescribeContributorInsightsErrorInternalServerError(value: v)
              Error(_) -> DescribeContributorInsightsErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DescribeContributorInsightsErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "ResourceNotFoundException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_resource_not_found_exception_struct()) {
              Ok(v) -> DescribeContributorInsightsErrorResourceNotFoundException(value: v)
              Error(_) -> DescribeContributorInsightsErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DescribeContributorInsightsErrorUnknown(error_type: et, status: s, body: "")
          }
          False -> case bit_array.to_string(b) {
          Ok(text) -> DescribeContributorInsightsErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> DescribeContributorInsightsErrorUnknown(error_type: et, status: s, body: "")
        }
        }
        }
    }
    awsjson_client.TransportError(_) -> DescribeContributorInsightsErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> DescribeContributorInsightsErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> DescribeContributorInsightsErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn decode_describe_endpoints_input(body: String) -> Result(DescribeEndpointsRequest, String) {
  case json.parse(body, decode_describe_endpoints_request_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}

pub fn decode_describe_endpoints_output(body: String) -> Result(DescribeEndpointsResponse, String) {
...
fn translate_describe_endpoints_error(err: awsjson_client.ClientError) -> DescribeEndpointsError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
case bit_array.to_string(b) {
          Ok(text) -> DescribeEndpointsErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> DescribeEndpointsErrorUnknown(error_type: et, status: s, body: "")
        }
    }
    awsjson_client.TransportError(_) -> DescribeEndpointsErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> DescribeEndpointsErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> DescribeEndpointsErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn decode_describe_export_input(body: String) -> Result(DescribeExportInput, String) {
  case json.parse(body, decode_describe_export_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}

pub fn decode_describe_export_output(body: String) -> Result(DescribeExportOutput, String) {
...
fn translate_describe_export_error(err: awsjson_client.ClientError) -> DescribeExportError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
        case awsjson_client.error_type_matches(et, "ExportNotFoundException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_export_not_found_exception_struct()) {
              Ok(v) -> DescribeExportErrorExportNotFoundException(value: v)
              Error(_) -> DescribeExportErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DescribeExportErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "InternalServerError") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_internal_server_error_struct()) {
              Ok(v) -> DescribeExportErrorInternalServerError(value: v)
              Error(_) -> DescribeExportErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DescribeExportErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_limit_exceeded_exception_struct()) {
              Ok(v) -> DescribeExportErrorLimitExceededException(value: v)
              Error(_) -> DescribeExportErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DescribeExportErrorUnknown(error_type: et, status: s, body: "")
          }
          False -> case bit_array.to_string(b) {
          Ok(text) -> DescribeExportErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> DescribeExportErrorUnknown(error_type: et, status: s, body: "")
        }
        }
        }
    ...
    awsjson_client.TransportError(_) -> DescribeExportErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> DescribeExportErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> DescribeExportErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn decode_describe_global_table_input(body: String) -> Result(DescribeGlobalTableInput, String) {
  case json.parse(body, decode_describe_global_table_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}

pub fn decode_describe_global_table_output(body: String) -> Result(DescribeGlobalTableOutput, String) {
...
fn translate_describe_global_table_error(err: awsjson_client.ClientError) -> DescribeGlobalTableError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
        case awsjson_client.error_type_matches(et, "GlobalTableNotFoundException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_global_table_not_found_exception_struct()) {
              Ok(v) -> DescribeGlobalTableErrorGlobalTableNotFoundException(value: v)
              Error(_) -> DescribeGlobalTableErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DescribeGlobalTableErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "InternalServerError") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_internal_server_error_struct()) {
              Ok(v) -> DescribeGlobalTableErrorInternalServerError(value: v)
              Error(_) -> DescribeGlobalTableErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DescribeGlobalTableErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_invalid_endpoint_exception_struct()) {
              Ok(v) -> DescribeGlobalTableErrorInvalidEndpointException(value: v)
              Error(_) -> DescribeGlobalTableErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DescribeGlobalTableErrorUnknown(error_type: et, status: s, body: "")
          }
          False -> case bit_array.to_string(b) {
          Ok(text) -> DescribeGlobalTableErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> DescribeGlobalTableErrorUnknown(error_type: et, status: s, body: "")
        }
        }
        }
    ...
    awsjson_client.TransportError(_) -> DescribeGlobalTableErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> DescribeGlobalTableErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> DescribeGlobalTableErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn decode_describe_global_table_settings_input(body: String) -> Result(DescribeGlobalTableSettingsInput, String) {
  case json.parse(body, decode_describe_global_table_settings_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}

pub fn decode_describe_global_table_settings_output(body: String) -> Result(DescribeGlobalTableSettingsOutput, String) {
...
fn translate_describe_global_table_settings_error(err: awsjson_client.ClientError) -> DescribeGlobalTableSettingsError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
        case awsjson_client.error_type_matches(et, "GlobalTableNotFoundException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_global_table_not_found_exception_struct()) {
              Ok(v) -> DescribeGlobalTableSettingsErrorGlobalTableNotFoundException(value: v)
              Error(_) -> DescribeGlobalTableSettingsErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DescribeGlobalTableSettingsErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "InternalServerError") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_internal_server_error_struct()) {
              Ok(v) -> DescribeGlobalTableSettingsErrorInternalServerError(value: v)
              Error(_) -> DescribeGlobalTableSettingsErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DescribeGlobalTableSettingsErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_invalid_endpoint_exception_struct()) {
              Ok(v) -> DescribeGlobalTableSettingsErrorInvalidEndpointException(value: v)
              Error(_) -> DescribeGlobalTableSettingsErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DescribeGlobalTableSettingsErrorUnknown(error_type: et, status: s, body: "")
          }
          False -> case bit_array.to_string(b) {
          Ok(text) -> DescribeGlobalTableSettingsErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> DescribeGlobalTableSettingsErrorUnknown(error_type: et, status: s, body: "")
        }
        }
        }
    ...
    awsjson_client.TransportError(_) -> DescribeGlobalTableSettingsErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> DescribeGlobalTableSettingsErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> DescribeGlobalTableSettingsErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn decode_describe_import_input(body: String) -> Result(DescribeImportInput, String) {
  case json.parse(body, decode_describe_import_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}

pub fn decode_describe_import_output(body: String) -> Result(DescribeImportOutput, String) {
...
fn translate_describe_import_error(err: awsjson_client.ClientError) -> DescribeImportError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
        case awsjson_client.error_type_matches(et, "ImportNotFoundException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_import_not_found_exception_struct()) {
              Ok(v) -> DescribeImportErrorImportNotFoundException(value: v)
              Error(_) -> DescribeImportErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DescribeImportErrorUnknown(error_type: et, status: s, body: "")
          }
          False -> case bit_array.to_string(b) {
          Ok(text) -> DescribeImportErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> DescribeImportErrorUnknown(error_type: et, status: s, body: "")
        }
        }
    }
    awsjson_client.TransportError(_) -> DescribeImportErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> DescribeImportErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> DescribeImportErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn decode_describe_kinesis_streaming_destination_input(body: String) -> Result(DescribeKinesisStreamingDestinationInput, String) {
  case json.parse(body, decode_describe_kinesis_streaming_destination_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}

pub fn decode_describe_kinesis_streaming_destination_output(body: String) -> Result(DescribeKinesisStreamingDestinationOutput, String) {
  case json.parse(body, decode_describe_kinesis_streaming_destination_output_struct()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}
...
fn translate_describe_kinesis_streaming_destination_error(err: awsjson_client.ClientError) -> DescribeKinesisStreamingDestinationError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
        case awsjson_client.error_type_matches(et, "InternalServerError") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_internal_server_error_struct()) {
              Ok(v) -> DescribeKinesisStreamingDestinationErrorInternalServerError(value: v)
              Error(_) -> DescribeKinesisStreamingDestinationErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DescribeKinesisStreamingDestinationErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "InvalidEndpointException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_invalid_endpoint_exception_struct()) {
              Ok(v) -> DescribeKinesisStreamingDestinationErrorInvalidEndpointException(value: v)
              Error(_) -> DescribeKinesisStreamingDestinationErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DescribeKinesisStreamingDestinationErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_resource_not_found_exception_struct()) {
              Ok(v) -> DescribeKinesisStreamingDestinationErrorResourceNotFoundException(value: v)
              Error(_) -> DescribeKinesisStreamingDestinationErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DescribeKinesisStreamingDestinationErrorUnknown(error_type: et, status: s, body: "")
          }
          False -> case bit_array.to_string(b) {
          Ok(text) -> DescribeKinesisStreamingDestinationErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> DescribeKinesisStreamingDestinationErrorUnknown(error_type: et, status: s, body: "")
        }
        }
        }
    ...
    awsjson_client.TransportError(_) -> DescribeKinesisStreamingDestinationErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> DescribeKinesisStreamingDestinationErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> DescribeKinesisStreamingDestinationErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn decode_describe_limits_input(body: String) -> Result(DescribeLimitsInput, String) {
  case json.parse(body, decode_describe_limits_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}

pub fn decode_describe_limits_output(body: String) -> Result(DescribeLimitsOutput, String) {
...
fn translate_describe_limits_error(err: awsjson_client.ClientError) -> DescribeLimitsError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
        case awsjson_client.error_type_matches(et, "InternalServerError") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_internal_server_error_struct()) {
              Ok(v) -> DescribeLimitsErrorInternalServerError(value: v)
              Error(_) -> DescribeLimitsErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DescribeLimitsErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "InvalidEndpointException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_invalid_endpoint_exception_struct()) {
              Ok(v) -> DescribeLimitsErrorInvalidEndpointException(value: v)
              Error(_) -> DescribeLimitsErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DescribeLimitsErrorUnknown(error_type: et, status: s, body: "")
          }
          False -> case bit_array.to_string(b) {
          Ok(text) -> DescribeLimitsErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> DescribeLimitsErrorUnknown(error_type: et, status: s, body: "")
        }
        }
        }
    }
    awsjson_client.TransportError(_) -> DescribeLimitsErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> DescribeLimitsErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> DescribeLimitsErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn decode_describe_table_input(body: String) -> Result(DescribeTableInput, String) {
  case json.parse(body, decode_describe_table_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}

pub fn decode_describe_table_output(body: String) -> Result(DescribeTableOutput, String) {
...
fn translate_describe_table_error(err: awsjson_client.ClientError) -> DescribeTableError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
        case awsjson_client.error_type_matches(et, "InternalServerError") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_internal_server_error_struct()) {
              Ok(v) -> DescribeTableErrorInternalServerError(value: v)
              Error(_) -> DescribeTableErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DescribeTableErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "InvalidEndpointException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_invalid_endpoint_exception_struct()) {
              Ok(v) -> DescribeTableErrorInvalidEndpointException(value: v)
              Error(_) -> DescribeTableErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DescribeTableErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_resource_not_found_exception_struct()) {
              Ok(v) -> DescribeTableErrorResourceNotFoundException(value: v)
              Error(_) -> DescribeTableErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DescribeTableErrorUnknown(error_type: et, status: s, body: "")
          }
          False -> case bit_array.to_string(b) {
          Ok(text) -> DescribeTableErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> DescribeTableErrorUnknown(error_type: et, status: s, body: "")
        }
        }
        }
    ...
    awsjson_client.TransportError(_) -> DescribeTableErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> DescribeTableErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> DescribeTableErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn decode_describe_table_replica_auto_scaling_input(body: String) -> Result(DescribeTableReplicaAutoScalingInput, String) {
  case json.parse(body, decode_describe_table_replica_auto_scaling_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}

pub fn decode_describe_table_replica_auto_scaling_output(body: String) -> Result(DescribeTableReplicaAutoScalingOutput, String) {
  case json.parse(body, decode_describe_table_replica_auto_scaling_output_struct()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}
...
fn translate_describe_table_replica_auto_scaling_error(err: awsjson_client.ClientError) -> DescribeTableReplicaAutoScalingError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
        case awsjson_client.error_type_matches(et, "InternalServerError") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_internal_server_error_struct()) {
              Ok(v) -> DescribeTableReplicaAutoScalingErrorInternalServerError(value: v)
              Error(_) -> DescribeTableReplicaAutoScalingErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DescribeTableReplicaAutoScalingErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "ResourceNotFoundException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_resource_not_found_exception_struct()) {
              Ok(v) -> DescribeTableReplicaAutoScalingErrorResourceNotFoundException(value: v)
              Error(_) -> DescribeTableReplicaAutoScalingErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DescribeTableReplicaAutoScalingErrorUnknown(error_type: et, status: s, body: "")
          }
          False -> case bit_array.to_string(b) {
          Ok(text) -> DescribeTableReplicaAutoScalingErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> DescribeTableReplicaAutoScalingErrorUnknown(error_type: et, status: s, body: "")
        }
        }
        }
    }
    awsjson_client.TransportError(_) -> DescribeTableReplicaAutoScalingErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> DescribeTableReplicaAutoScalingErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> DescribeTableReplicaAutoScalingErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn decode_describe_time_to_live_input(body: String) -> Result(DescribeTimeToLiveInput, String) {
  case json.parse(body, decode_describe_time_to_live_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}

pub fn decode_describe_time_to_live_output(body: String) -> Result(DescribeTimeToLiveOutput, String) {
...
fn translate_describe_time_to_live_error(err: awsjson_client.ClientError) -> DescribeTimeToLiveError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
        case awsjson_client.error_type_matches(et, "InternalServerError") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_internal_server_error_struct()) {
              Ok(v) -> DescribeTimeToLiveErrorInternalServerError(value: v)
              Error(_) -> DescribeTimeToLiveErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DescribeTimeToLiveErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "InvalidEndpointException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_invalid_endpoint_exception_struct()) {
              Ok(v) -> DescribeTimeToLiveErrorInvalidEndpointException(value: v)
              Error(_) -> DescribeTimeToLiveErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DescribeTimeToLiveErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_resource_not_found_exception_struct()) {
              Ok(v) -> DescribeTimeToLiveErrorResourceNotFoundException(value: v)
              Error(_) -> DescribeTimeToLiveErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DescribeTimeToLiveErrorUnknown(error_type: et, status: s, body: "")
          }
          False -> case bit_array.to_string(b) {
          Ok(text) -> DescribeTimeToLiveErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> DescribeTimeToLiveErrorUnknown(error_type: et, status: s, body: "")
        }
        }
        }
    ...
    awsjson_client.TransportError(_) -> DescribeTimeToLiveErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> DescribeTimeToLiveErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> DescribeTimeToLiveErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn decode_disable_kinesis_streaming_destination_input(body: String) -> Result(KinesisStreamingDestinationInput, String) {
  case json.parse(body, decode_kinesis_streaming_destination_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}

pub fn decode_disable_kinesis_streaming_destination_output(body: String) -> Result(KinesisStreamingDestinationOutput, String) {
...
fn translate_disable_kinesis_streaming_destination_error(err: awsjson_client.ClientError) -> DisableKinesisStreamingDestinationError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
        case awsjson_client.error_type_matches(et, "InternalServerError") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_internal_server_error_struct()) {
              Ok(v) -> DisableKinesisStreamingDestinationErrorInternalServerError(value: v)
              Error(_) -> DisableKinesisStreamingDestinationErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DisableKinesisStreamingDestinationErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "InvalidEndpointException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_invalid_endpoint_exception_struct()) {
              Ok(v) -> DisableKinesisStreamingDestinationErrorInvalidEndpointException(value: v)
              Error(_) -> DisableKinesisStreamingDestinationErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DisableKinesisStreamingDestinationErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_limit_exceeded_exception_struct()) {
              Ok(v) -> DisableKinesisStreamingDestinationErrorLimitExceededException(value: v)
              Error(_) -> DisableKinesisStreamingDestinationErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DisableKinesisStreamingDestinationErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_resource_in_use_exception_struct()) {
              Ok(v) -> DisableKinesisStreamingDestinationErrorResourceInUseException(value: v)
              Error(_) -> DisableKinesisStreamingDestinationErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DisableKinesisStreamingDestinationErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_resource_not_found_exception_struct()) {
              Ok(v) -> DisableKinesisStreamingDestinationErrorResourceNotFoundException(value: v)
              Error(_) -> DisableKinesisStreamingDestinationErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> DisableKinesisStreamingDestinationErrorUnknown(error_type: et, status: s, body: "")
          }
          False -> case bit_array.to_string(b) {
          Ok(text) -> DisableKinesisStreamingDestinationErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> DisableKinesisStreamingDestinationErrorUnknown(error_type: et, status: s, body: "")
        }
        }
        }
    ...
    awsjson_client.TransportError(_) -> DisableKinesisStreamingDestinationErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> DisableKinesisStreamingDestinationErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> DisableKinesisStreamingDestinationErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn decode_enable_kinesis_streaming_destination_output(body: String) -> Result(KinesisStreamingDestinationOutput, String) {
  case json.parse(body, decode_kinesis_streaming_destination_output_struct()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
...
fn translate_enable_kinesis_streaming_destination_error(err: awsjson_client.ClientError) -> EnableKinesisStreamingDestinationError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
        case awsjson_client.error_type_matches(et, "InternalServerError") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_internal_server_error_struct()) {
              Ok(v) -> EnableKinesisStreamingDestinationErrorInternalServerError(value: v)
              Error(_) -> EnableKinesisStreamingDestinationErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> EnableKinesisStreamingDestinationErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "InvalidEndpointException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_invalid_endpoint_exception_struct()) {
              Ok(v) -> EnableKinesisStreamingDestinationErrorInvalidEndpointException(value: v)
              Error(_) -> EnableKinesisStreamingDestinationErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> EnableKinesisStreamingDestinationErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_limit_exceeded_exception_struct()) {
              Ok(v) -> EnableKinesisStreamingDestinationErrorLimitExceededException(value: v)
              Error(_) -> EnableKinesisStreamingDestinationErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> EnableKinesisStreamingDestinationErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_resource_in_use_exception_struct()) {
              Ok(v) -> EnableKinesisStreamingDestinationErrorResourceInUseException(value: v)
              Error(_) -> EnableKinesisStreamingDestinationErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> EnableKinesisStreamingDestinationErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_resource_not_found_exception_struct()) {
              Ok(v) -> EnableKinesisStreamingDestinationErrorResourceNotFoundException(value: v)
              Error(_) -> EnableKinesisStreamingDestinationErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> EnableKinesisStreamingDestinationErrorUnknown(error_type: et, status: s, body: "")
          }
          False -> case bit_array.to_string(b) {
          Ok(text) -> EnableKinesisStreamingDestinationErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> EnableKinesisStreamingDestinationErrorUnknown(error_type: et, status: s, body: "")
        }
        }
        }
    ...
    awsjson_client.TransportError(_) -> EnableKinesisStreamingDestinationErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> EnableKinesisStreamingDestinationErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> EnableKinesisStreamingDestinationErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn decode_execute_statement_input(body: String) -> Result(ExecuteStatementInput, String) {
  case json.parse(body, decode_execute_statement_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}

pub fn decode_execute_statement_output(body: String) -> Result(ExecuteStatementOutput, String) {
...
fn translate_execute_statement_error(err: awsjson_client.ClientError) -> ExecuteStatementError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
        case awsjson_client.error_type_matches(et, "ConditionalCheckFailedException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_conditional_check_failed_exception_struct()) {
              Ok(v) -> ExecuteStatementErrorConditionalCheckFailedException(value: v)
              Error(_) -> ExecuteStatementErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> ExecuteStatementErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "DuplicateItemException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_duplicate_item_exception_struct()) {
              Ok(v) -> ExecuteStatementErrorDuplicateItemException(value: v)
              Error(_) -> ExecuteStatementErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> ExecuteStatementErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_internal_server_error_struct()) {
              Ok(v) -> ExecuteStatementErrorInternalServerError(value: v)
              Error(_) -> ExecuteStatementErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> ExecuteStatementErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_item_collection_size_limit_exceeded_exception_struct()) {
              Ok(v) -> ExecuteStatementErrorItemCollectionSizeLimitExceededException(value: v)
              Error(_) -> ExecuteStatementErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> ExecuteStatementErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_provisioned_throughput_exceeded_exception_struct()) {
              Ok(v) -> ExecuteStatementErrorProvisionedThroughputExceededException(value: v)
              Error(_) -> ExecuteStatementErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> ExecuteStatementErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_request_limit_exceeded_struct()) {
              Ok(v) -> ExecuteStatementErrorRequestLimitExceeded(value: v)
              Error(_) -> ExecuteStatementErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> ExecuteStatementErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_resource_not_found_exception_struct()) {
              Ok(v) -> ExecuteStatementErrorResourceNotFoundException(value: v)
              Error(_) -> ExecuteStatementErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> ExecuteStatementErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_throttling_exception_struct()) {
              Ok(v) -> ExecuteStatementErrorThrottlingException(value: v)
              Error(_) -> ExecuteStatementErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> ExecuteStatementErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_transaction_conflict_exception_struct()) {
              Ok(v) -> ExecuteStatementErrorTransactionConflictException(value: v)
              Error(_) -> ExecuteStatementErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> ExecuteStatementErrorUnknown(error_type: et, status: s, body: "")
          }
          False -> case bit_array.to_string(b) {
          Ok(text) -> ExecuteStatementErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> ExecuteStatementErrorUnknown(error_type: et, status: s, body: "")
        }
        }
        }
    ...
    awsjson_client.TransportError(_) -> ExecuteStatementErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> ExecuteStatementErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> ExecuteStatementErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn decode_execute_transaction_input(body: String) -> Result(ExecuteTransactionInput, String) {
  case json.parse(body, decode_execute_transaction_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}

pub fn decode_execute_transaction_output(body: String) -> Result(ExecuteTransactionOutput, String) {
...
fn translate_execute_transaction_error(err: awsjson_client.ClientError) -> ExecuteTransactionError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
        case awsjson_client.error_type_matches(et, "IdempotentParameterMismatchException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_idempotent_parameter_mismatch_exception_struct()) {
              Ok(v) -> ExecuteTransactionErrorIdempotentParameterMismatchException(value: v)
              Error(_) -> ExecuteTransactionErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> ExecuteTransactionErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "InternalServerError") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_internal_server_error_struct()) {
              Ok(v) -> ExecuteTransactionErrorInternalServerError(value: v)
              Error(_) -> ExecuteTransactionErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> ExecuteTransactionErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_provisioned_throughput_exceeded_exception_struct()) {
              Ok(v) -> ExecuteTransactionErrorProvisionedThroughputExceededException(value: v)
              Error(_) -> ExecuteTransactionErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> ExecuteTransactionErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_request_limit_exceeded_struct()) {
              Ok(v) -> ExecuteTransactionErrorRequestLimitExceeded(value: v)
              Error(_) -> ExecuteTransactionErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> ExecuteTransactionErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_resource_not_found_exception_struct()) {
              Ok(v) -> ExecuteTransactionErrorResourceNotFoundException(value: v)
              Error(_) -> ExecuteTransactionErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> ExecuteTransactionErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_throttling_exception_struct()) {
              Ok(v) -> ExecuteTransactionErrorThrottlingException(value: v)
              Error(_) -> ExecuteTransactionErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> ExecuteTransactionErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "TransactionCanceledException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_transaction_canceled_exception_struct()) {
              Ok(v) -> ExecuteTransactionErrorTransactionCanceledException(value: v)
              Error(_) -> ExecuteTransactionErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> ExecuteTransactionErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "TransactionInProgressException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_transaction_in_progress_exception_struct()) {
              Ok(v) -> ExecuteTransactionErrorTransactionInProgressException(value: v)
              Error(_) -> ExecuteTransactionErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> ExecuteTransactionErrorUnknown(error_type: et, status: s, body: "")
          }
          False -> case bit_array.to_string(b) {
          Ok(text) -> ExecuteTransactionErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> ExecuteTransactionErrorUnknown(error_type: et, status: s, body: "")
        }
        }
        }
    ...
    awsjson_client.TransportError(_) -> ExecuteTransactionErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> ExecuteTransactionErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> ExecuteTransactionErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn decode_export_table_to_point_in_time_input(body: String) -> Result(ExportTableToPointInTimeInput, String) {
  case json.parse(body, decode_export_table_to_point_in_time_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}

pub fn decode_export_table_to_point_in_time_output(body: String) -> Result(ExportTableToPointInTimeOutput, String) {
...
fn translate_export_table_to_point_in_time_error(err: awsjson_client.ClientError) -> ExportTableToPointInTimeError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
        case awsjson_client.error_type_matches(et, "ExportConflictException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_export_conflict_exception_struct()) {
              Ok(v) -> ExportTableToPointInTimeErrorExportConflictException(value: v)
              Error(_) -> ExportTableToPointInTimeErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> ExportTableToPointInTimeErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "InternalServerError") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_internal_server_error_struct()) {
              Ok(v) -> ExportTableToPointInTimeErrorInternalServerError(value: v)
              Error(_) -> ExportTableToPointInTimeErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> ExportTableToPointInTimeErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "InvalidExportTimeException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_invalid_export_time_exception_struct()) {
              Ok(v) -> ExportTableToPointInTimeErrorInvalidExportTimeException(value: v)
              Error(_) -> ExportTableToPointInTimeErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> ExportTableToPointInTimeErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_limit_exceeded_exception_struct()) {
              Ok(v) -> ExportTableToPointInTimeErrorLimitExceededException(value: v)
              Error(_) -> ExportTableToPointInTimeErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> ExportTableToPointInTimeErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "PointInTimeRecoveryUnavailableException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_point_in_time_recovery_unavailable_exception_struct()) {
              Ok(v) -> ExportTableToPointInTimeErrorPointInTimeRecoveryUnavailableException(value: v)
              Error(_) -> ExportTableToPointInTimeErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> ExportTableToPointInTimeErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_table_not_found_exception_struct()) {
              Ok(v) -> ExportTableToPointInTimeErrorTableNotFoundException(value: v)
              Error(_) -> ExportTableToPointInTimeErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> ExportTableToPointInTimeErrorUnknown(error_type: et, status: s, body: "")
          }
          False -> case bit_array.to_string(b) {
          Ok(text) -> ExportTableToPointInTimeErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> ExportTableToPointInTimeErrorUnknown(error_type: et, status: s, body: "")
        }
        }
        }
    ...
    awsjson_client.TransportError(_) -> ExportTableToPointInTimeErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> ExportTableToPointInTimeErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> ExportTableToPointInTimeErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn decode_get_item_input(body: String) -> Result(GetItemInput, String) {
  case json.parse(body, decode_get_item_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}
...
fn translate_get_item_error(err: awsjson_client.ClientError) -> GetItemError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
        case awsjson_client.error_type_matches(et, "InternalServerError") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_internal_server_error_struct()) {
              Ok(v) -> GetItemErrorInternalServerError(value: v)
              Error(_) -> GetItemErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> GetItemErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "InvalidEndpointException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_invalid_endpoint_exception_struct()) {
              Ok(v) -> GetItemErrorInvalidEndpointException(value: v)
              Error(_) -> GetItemErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> GetItemErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_provisioned_throughput_exceeded_exception_struct()) {
              Ok(v) -> GetItemErrorProvisionedThroughputExceededException(value: v)
              Error(_) -> GetItemErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> GetItemErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_request_limit_exceeded_struct()) {
              Ok(v) -> GetItemErrorRequestLimitExceeded(value: v)
              Error(_) -> GetItemErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> GetItemErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_resource_not_found_exception_struct()) {
              Ok(v) -> GetItemErrorResourceNotFoundException(value: v)
              Error(_) -> GetItemErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> GetItemErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_throttling_exception_struct()) {
              Ok(v) -> GetItemErrorThrottlingException(value: v)
              Error(_) -> GetItemErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> GetItemErrorUnknown(error_type: et, status: s, body: "")
          }
          False -> case bit_array.to_string(b) {
          Ok(text) -> GetItemErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> GetItemErrorUnknown(error_type: et, status: s, body: "")
        }
        }
        }
    ...
    awsjson_client.TransportError(_) -> GetItemErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> GetItemErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> GetItemErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn decode_get_resource_policy_input(body: String) -> Result(GetResourcePolicyInput, String) {
  case json.parse(body, decode_get_resource_policy_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}

pub fn decode_get_resource_policy_output(body: String) -> Result(GetResourcePolicyOutput, String) {
...
fn translate_get_resource_policy_error(err: awsjson_client.ClientError) -> GetResourcePolicyError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
        case awsjson_client.error_type_matches(et, "InternalServerError") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_internal_server_error_struct()) {
              Ok(v) -> GetResourcePolicyErrorInternalServerError(value: v)
              Error(_) -> GetResourcePolicyErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> GetResourcePolicyErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "InvalidEndpointException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_invalid_endpoint_exception_struct()) {
              Ok(v) -> GetResourcePolicyErrorInvalidEndpointException(value: v)
              Error(_) -> GetResourcePolicyErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> GetResourcePolicyErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_policy_not_found_exception_struct()) {
              Ok(v) -> GetResourcePolicyErrorPolicyNotFoundException(value: v)
              Error(_) -> GetResourcePolicyErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> GetResourcePolicyErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_resource_not_found_exception_struct()) {
              Ok(v) -> GetResourcePolicyErrorResourceNotFoundException(value: v)
              Error(_) -> GetResourcePolicyErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> GetResourcePolicyErrorUnknown(error_type: et, status: s, body: "")
          }
          False -> case bit_array.to_string(b) {
          Ok(text) -> GetResourcePolicyErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> GetResourcePolicyErrorUnknown(error_type: et, status: s, body: "")
        }
        }
        }
    ...
    awsjson_client.TransportError(_) -> GetResourcePolicyErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> GetResourcePolicyErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> GetResourcePolicyErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn decode_import_table_input(body: String) -> Result(ImportTableInput, String) {
  case json.parse(body, decode_import_table_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}

pub fn decode_import_table_output(body: String) -> Result(ImportTableOutput, String) {
...
fn translate_import_table_error(err: awsjson_client.ClientError) -> ImportTableError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
        case awsjson_client.error_type_matches(et, "ImportConflictException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_import_conflict_exception_struct()) {
              Ok(v) -> ImportTableErrorImportConflictException(value: v)
              Error(_) -> ImportTableErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> ImportTableErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "LimitExceededException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_limit_exceeded_exception_struct()) {
              Ok(v) -> ImportTableErrorLimitExceededException(value: v)
              Error(_) -> ImportTableErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> ImportTableErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_resource_in_use_exception_struct()) {
              Ok(v) -> ImportTableErrorResourceInUseException(value: v)
              Error(_) -> ImportTableErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> ImportTableErrorUnknown(error_type: et, status: s, body: "")
          }
          False -> case bit_array.to_string(b) {
          Ok(text) -> ImportTableErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> ImportTableErrorUnknown(error_type: et, status: s, body: "")
        }
        }
        }
    ...
    awsjson_client.TransportError(_) -> ImportTableErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> ImportTableErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> ImportTableErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn decode_list_backups_input(body: String) -> Result(ListBackupsInput, String) {
  case json.parse(body, decode_list_backups_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}

pub fn decode_list_backups_output(body: String) -> Result(ListBackupsOutput, String) {
...
fn translate_list_backups_error(err: awsjson_client.ClientError) -> ListBackupsError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
        case awsjson_client.error_type_matches(et, "InternalServerError") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_internal_server_error_struct()) {
              Ok(v) -> ListBackupsErrorInternalServerError(value: v)
              Error(_) -> ListBackupsErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> ListBackupsErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "InvalidEndpointException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_invalid_endpoint_exception_struct()) {
              Ok(v) -> ListBackupsErrorInvalidEndpointException(value: v)
              Error(_) -> ListBackupsErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> ListBackupsErrorUnknown(error_type: et, status: s, body: "")
          }
          False -> case bit_array.to_string(b) {
          Ok(text) -> ListBackupsErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> ListBackupsErrorUnknown(error_type: et, status: s, body: "")
        }
        }
        }
    }
    awsjson_client.TransportError(_) -> ListBackupsErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> ListBackupsErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> ListBackupsErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn decode_list_contributor_insights_input(body: String) -> Result(ListContributorInsightsInput, String) {
  case json.parse(body, decode_list_contributor_insights_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}

pub fn decode_list_contributor_insights_output(body: String) -> Result(ListContributorInsightsOutput, String) {
...
fn translate_list_contributor_insights_error(err: awsjson_client.ClientError) -> ListContributorInsightsError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
        case awsjson_client.error_type_matches(et, "InternalServerError") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_internal_server_error_struct()) {
              Ok(v) -> ListContributorInsightsErrorInternalServerError(value: v)
              Error(_) -> ListContributorInsightsErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> ListContributorInsightsErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "ResourceNotFoundException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_resource_not_found_exception_struct()) {
              Ok(v) -> ListContributorInsightsErrorResourceNotFoundException(value: v)
              Error(_) -> ListContributorInsightsErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> ListContributorInsightsErrorUnknown(error_type: et, status: s, body: "")
          }
          False -> case bit_array.to_string(b) {
          Ok(text) -> ListContributorInsightsErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> ListContributorInsightsErrorUnknown(error_type: et, status: s, body: "")
        }
        }
        }
    }
    awsjson_client.TransportError(_) -> ListContributorInsightsErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> ListContributorInsightsErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> ListContributorInsightsErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn decode_list_exports_input(body: String) -> Result(ListExportsInput, String) {
  case json.parse(body, decode_list_exports_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}

pub fn decode_list_exports_output(body: String) -> Result(ListExportsOutput, String) {
...
fn translate_list_exports_error(err: awsjson_client.ClientError) -> ListExportsError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
        case awsjson_client.error_type_matches(et, "InternalServerError") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_internal_server_error_struct()) {
              Ok(v) -> ListExportsErrorInternalServerError(value: v)
              Error(_) -> ListExportsErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> ListExportsErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "LimitExceededException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_limit_exceeded_exception_struct()) {
              Ok(v) -> ListExportsErrorLimitExceededException(value: v)
              Error(_) -> ListExportsErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> ListExportsErrorUnknown(error_type: et, status: s, body: "")
          }
          False -> case bit_array.to_string(b) {
          Ok(text) -> ListExportsErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> ListExportsErrorUnknown(error_type: et, status: s, body: "")
        }
        }
        }
    }
    awsjson_client.TransportError(_) -> ListExportsErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> ListExportsErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> ListExportsErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn decode_list_global_tables_input(body: String) -> Result(ListGlobalTablesInput, String) {
  case json.parse(body, decode_list_global_tables_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}

pub fn decode_list_global_tables_output(body: String) -> Result(ListGlobalTablesOutput, String) {
...
fn translate_list_global_tables_error(err: awsjson_client.ClientError) -> ListGlobalTablesError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
        case awsjson_client.error_type_matches(et, "InternalServerError") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_internal_server_error_struct()) {
              Ok(v) -> ListGlobalTablesErrorInternalServerError(value: v)
              Error(_) -> ListGlobalTablesErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> ListGlobalTablesErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "InvalidEndpointException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_invalid_endpoint_exception_struct()) {
              Ok(v) -> ListGlobalTablesErrorInvalidEndpointException(value: v)
              Error(_) -> ListGlobalTablesErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> ListGlobalTablesErrorUnknown(error_type: et, status: s, body: "")
          }
          False -> case bit_array.to_string(b) {
          Ok(text) -> ListGlobalTablesErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> ListGlobalTablesErrorUnknown(error_type: et, status: s, body: "")
        }
        }
        }
    }
    awsjson_client.TransportError(_) -> ListGlobalTablesErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> ListGlobalTablesErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> ListGlobalTablesErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn decode_list_imports_input(body: String) -> Result(ListImportsInput, String) {
  case json.parse(body, decode_list_imports_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}

pub fn decode_list_imports_output(body: String) -> Result(ListImportsOutput, String) {
...
fn translate_list_imports_error(err: awsjson_client.ClientError) -> ListImportsError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
        case awsjson_client.error_type_matches(et, "LimitExceededException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_limit_exceeded_exception_struct()) {
              Ok(v) -> ListImportsErrorLimitExceededException(value: v)
              Error(_) -> ListImportsErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> ListImportsErrorUnknown(error_type: et, status: s, body: "")
          }
          False -> case bit_array.to_string(b) {
          Ok(text) -> ListImportsErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> ListImportsErrorUnknown(error_type: et, status: s, body: "")
        }
        }
    }
    awsjson_client.TransportError(_) -> ListImportsErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> ListImportsErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> ListImportsErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn decode_list_tables_input(body: String) -> Result(ListTablesInput, String) {
  case json.parse(body, decode_list_tables_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}

pub fn decode_list_tables_output(body: String) -> Result(ListTablesOutput, String) {
...
fn translate_list_tables_error(err: awsjson_client.ClientError) -> ListTablesError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
        case awsjson_client.error_type_matches(et, "InternalServerError") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_internal_server_error_struct()) {
              Ok(v) -> ListTablesErrorInternalServerError(value: v)
              Error(_) -> ListTablesErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> ListTablesErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "InvalidEndpointException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_invalid_endpoint_exception_struct()) {
              Ok(v) -> ListTablesErrorInvalidEndpointException(value: v)
              Error(_) -> ListTablesErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> ListTablesErrorUnknown(error_type: et, status: s, body: "")
          }
          False -> case bit_array.to_string(b) {
          Ok(text) -> ListTablesErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> ListTablesErrorUnknown(error_type: et, status: s, body: "")
        }
        }
        }
    }
    awsjson_client.TransportError(_) -> ListTablesErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> ListTablesErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> ListTablesErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn decode_list_tags_of_resource_input(body: String) -> Result(ListTagsOfResourceInput, String) {
  case json.parse(body, decode_list_tags_of_resource_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}

pub fn decode_list_tags_of_resource_output(body: String) -> Result(ListTagsOfResourceOutput, String) {
...
fn translate_list_tags_of_resource_error(err: awsjson_client.ClientError) -> ListTagsOfResourceError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
        case awsjson_client.error_type_matches(et, "InternalServerError") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_internal_server_error_struct()) {
              Ok(v) -> ListTagsOfResourceErrorInternalServerError(value: v)
              Error(_) -> ListTagsOfResourceErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> ListTagsOfResourceErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "InvalidEndpointException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_invalid_endpoint_exception_struct()) {
              Ok(v) -> ListTagsOfResourceErrorInvalidEndpointException(value: v)
              Error(_) -> ListTagsOfResourceErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> ListTagsOfResourceErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_resource_not_found_exception_struct()) {
              Ok(v) -> ListTagsOfResourceErrorResourceNotFoundException(value: v)
              Error(_) -> ListTagsOfResourceErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> ListTagsOfResourceErrorUnknown(error_type: et, status: s, body: "")
          }
          False -> case bit_array.to_string(b) {
          Ok(text) -> ListTagsOfResourceErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> ListTagsOfResourceErrorUnknown(error_type: et, status: s, body: "")
        }
        }
        }
    ...
    awsjson_client.TransportError(_) -> ListTagsOfResourceErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> ListTagsOfResourceErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> ListTagsOfResourceErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn decode_put_item_input(body: String) -> Result(PutItemInput, String) {
  case json.parse(body, decode_put_item_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}
...
fn translate_put_item_error(err: awsjson_client.ClientError) -> PutItemError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
        case awsjson_client.error_type_matches(et, "ConditionalCheckFailedException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_conditional_check_failed_exception_struct()) {
              Ok(v) -> PutItemErrorConditionalCheckFailedException(value: v)
              Error(_) -> PutItemErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> PutItemErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "InternalServerError") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_internal_server_error_struct()) {
              Ok(v) -> PutItemErrorInternalServerError(value: v)
              Error(_) -> PutItemErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> PutItemErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_invalid_endpoint_exception_struct()) {
              Ok(v) -> PutItemErrorInvalidEndpointException(value: v)
              Error(_) -> PutItemErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> PutItemErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_item_collection_size_limit_exceeded_exception_struct()) {
              Ok(v) -> PutItemErrorItemCollectionSizeLimitExceededException(value: v)
              Error(_) -> PutItemErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> PutItemErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_provisioned_throughput_exceeded_exception_struct()) {
              Ok(v) -> PutItemErrorProvisionedThroughputExceededException(value: v)
              Error(_) -> PutItemErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> PutItemErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_replicated_write_conflict_exception_struct()) {
              Ok(v) -> PutItemErrorReplicatedWriteConflictException(value: v)
              Error(_) -> PutItemErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> PutItemErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_request_limit_exceeded_struct()) {
              Ok(v) -> PutItemErrorRequestLimitExceeded(value: v)
              Error(_) -> PutItemErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> PutItemErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_resource_not_found_exception_struct()) {
              Ok(v) -> PutItemErrorResourceNotFoundException(value: v)
              Error(_) -> PutItemErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> PutItemErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_throttling_exception_struct()) {
              Ok(v) -> PutItemErrorThrottlingException(value: v)
              Error(_) -> PutItemErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> PutItemErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_transaction_conflict_exception_struct()) {
              Ok(v) -> PutItemErrorTransactionConflictException(value: v)
              Error(_) -> PutItemErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> PutItemErrorUnknown(error_type: et, status: s, body: "")
          }
          False -> case bit_array.to_string(b) {
          Ok(text) -> PutItemErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> PutItemErrorUnknown(error_type: et, status: s, body: "")
        }
        }
        }
    ...
    awsjson_client.TransportError(_) -> PutItemErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> PutItemErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> PutItemErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn decode_put_resource_policy_input(body: String) -> Result(PutResourcePolicyInput, String) {
  case json.parse(body, decode_put_resource_policy_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}

pub fn decode_put_resource_policy_output(body: String) -> Result(PutResourcePolicyOutput, String) {
...
fn translate_put_resource_policy_error(err: awsjson_client.ClientError) -> PutResourcePolicyError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
        case awsjson_client.error_type_matches(et, "InternalServerError") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_internal_server_error_struct()) {
              Ok(v) -> PutResourcePolicyErrorInternalServerError(value: v)
              Error(_) -> PutResourcePolicyErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> PutResourcePolicyErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "InvalidEndpointException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_invalid_endpoint_exception_struct()) {
              Ok(v) -> PutResourcePolicyErrorInvalidEndpointException(value: v)
              Error(_) -> PutResourcePolicyErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> PutResourcePolicyErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_limit_exceeded_exception_struct()) {
              Ok(v) -> PutResourcePolicyErrorLimitExceededException(value: v)
              Error(_) -> PutResourcePolicyErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> PutResourcePolicyErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_policy_not_found_exception_struct()) {
              Ok(v) -> PutResourcePolicyErrorPolicyNotFoundException(value: v)
              Error(_) -> PutResourcePolicyErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> PutResourcePolicyErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_resource_in_use_exception_struct()) {
              Ok(v) -> PutResourcePolicyErrorResourceInUseException(value: v)
              Error(_) -> PutResourcePolicyErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> PutResourcePolicyErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_resource_not_found_exception_struct()) {
              Ok(v) -> PutResourcePolicyErrorResourceNotFoundException(value: v)
              Error(_) -> PutResourcePolicyErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> PutResourcePolicyErrorUnknown(error_type: et, status: s, body: "")
          }
          False -> case bit_array.to_string(b) {
          Ok(text) -> PutResourcePolicyErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> PutResourcePolicyErrorUnknown(error_type: et, status: s, body: "")
        }
        }
        }
    ...
    awsjson_client.TransportError(_) -> PutResourcePolicyErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> PutResourcePolicyErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> PutResourcePolicyErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn decode_query_input(body: String) -> Result(QueryInput, String) {
  case json.parse(body, decode_query_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}
...
fn translate_query_error(err: awsjson_client.ClientError) -> QueryError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
        case awsjson_client.error_type_matches(et, "InternalServerError") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_internal_server_error_struct()) {
              Ok(v) -> QueryErrorInternalServerError(value: v)
              Error(_) -> QueryErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> QueryErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "InvalidEndpointException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_invalid_endpoint_exception_struct()) {
              Ok(v) -> QueryErrorInvalidEndpointException(value: v)
              Error(_) -> QueryErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> QueryErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_provisioned_throughput_exceeded_exception_struct()) {
              Ok(v) -> QueryErrorProvisionedThroughputExceededException(value: v)
              Error(_) -> QueryErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> QueryErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_request_limit_exceeded_struct()) {
              Ok(v) -> QueryErrorRequestLimitExceeded(value: v)
              Error(_) -> QueryErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> QueryErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_resource_not_found_exception_struct()) {
              Ok(v) -> QueryErrorResourceNotFoundException(value: v)
              Error(_) -> QueryErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> QueryErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_throttling_exception_struct()) {
              Ok(v) -> QueryErrorThrottlingException(value: v)
              Error(_) -> QueryErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> QueryErrorUnknown(error_type: et, status: s, body: "")
          }
          False -> case bit_array.to_string(b) {
          Ok(text) -> QueryErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> QueryErrorUnknown(error_type: et, status: s, body: "")
        }
        }
        }
    ...
    awsjson_client.TransportError(_) -> QueryErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> QueryErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> QueryErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn decode_restore_table_from_backup_input(body: String) -> Result(RestoreTableFromBackupInput, String) {
  case json.parse(body, decode_restore_table_from_backup_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}

pub fn decode_restore_table_from_backup_output(body: String) -> Result(RestoreTableFromBackupOutput, String) {
...
fn translate_restore_table_from_backup_error(err: awsjson_client.ClientError) -> RestoreTableFromBackupError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
        case awsjson_client.error_type_matches(et, "BackupInUseException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_backup_in_use_exception_struct()) {
              Ok(v) -> RestoreTableFromBackupErrorBackupInUseException(value: v)
              Error(_) -> RestoreTableFromBackupErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> RestoreTableFromBackupErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "BackupNotFoundException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_backup_not_found_exception_struct()) {
              Ok(v) -> RestoreTableFromBackupErrorBackupNotFoundException(value: v)
              Error(_) -> RestoreTableFromBackupErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> RestoreTableFromBackupErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_internal_server_error_struct()) {
              Ok(v) -> RestoreTableFromBackupErrorInternalServerError(value: v)
              Error(_) -> RestoreTableFromBackupErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> RestoreTableFromBackupErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_invalid_endpoint_exception_struct()) {
              Ok(v) -> RestoreTableFromBackupErrorInvalidEndpointException(value: v)
              Error(_) -> RestoreTableFromBackupErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> RestoreTableFromBackupErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_limit_exceeded_exception_struct()) {
              Ok(v) -> RestoreTableFromBackupErrorLimitExceededException(value: v)
              Error(_) -> RestoreTableFromBackupErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> RestoreTableFromBackupErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "TableAlreadyExistsException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_table_already_exists_exception_struct()) {
              Ok(v) -> RestoreTableFromBackupErrorTableAlreadyExistsException(value: v)
              Error(_) -> RestoreTableFromBackupErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> RestoreTableFromBackupErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_table_in_use_exception_struct()) {
              Ok(v) -> RestoreTableFromBackupErrorTableInUseException(value: v)
              Error(_) -> RestoreTableFromBackupErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> RestoreTableFromBackupErrorUnknown(error_type: et, status: s, body: "")
          }
          False -> case bit_array.to_string(b) {
          Ok(text) -> RestoreTableFromBackupErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> RestoreTableFromBackupErrorUnknown(error_type: et, status: s, body: "")
        }
        }
        }
    ...
    awsjson_client.TransportError(_) -> RestoreTableFromBackupErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> RestoreTableFromBackupErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> RestoreTableFromBackupErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn decode_restore_table_to_point_in_time_input(body: String) -> Result(RestoreTableToPointInTimeInput, String) {
  case json.parse(body, decode_restore_table_to_point_in_time_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}

pub fn decode_restore_table_to_point_in_time_output(body: String) -> Result(RestoreTableToPointInTimeOutput, String) {
...
fn translate_restore_table_to_point_in_time_error(err: awsjson_client.ClientError) -> RestoreTableToPointInTimeError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
        case awsjson_client.error_type_matches(et, "InternalServerError") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_internal_server_error_struct()) {
              Ok(v) -> RestoreTableToPointInTimeErrorInternalServerError(value: v)
              Error(_) -> RestoreTableToPointInTimeErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> RestoreTableToPointInTimeErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "InvalidEndpointException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_invalid_endpoint_exception_struct()) {
              Ok(v) -> RestoreTableToPointInTimeErrorInvalidEndpointException(value: v)
              Error(_) -> RestoreTableToPointInTimeErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> RestoreTableToPointInTimeErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "InvalidRestoreTimeException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_invalid_restore_time_exception_struct()) {
              Ok(v) -> RestoreTableToPointInTimeErrorInvalidRestoreTimeException(value: v)
              Error(_) -> RestoreTableToPointInTimeErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> RestoreTableToPointInTimeErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_limit_exceeded_exception_struct()) {
              Ok(v) -> RestoreTableToPointInTimeErrorLimitExceededException(value: v)
              Error(_) -> RestoreTableToPointInTimeErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> RestoreTableToPointInTimeErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_point_in_time_recovery_unavailable_exception_struct()) {
              Ok(v) -> RestoreTableToPointInTimeErrorPointInTimeRecoveryUnavailableException(value: v)
              Error(_) -> RestoreTableToPointInTimeErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> RestoreTableToPointInTimeErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_table_already_exists_exception_struct()) {
              Ok(v) -> RestoreTableToPointInTimeErrorTableAlreadyExistsException(value: v)
              Error(_) -> RestoreTableToPointInTimeErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> RestoreTableToPointInTimeErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_table_in_use_exception_struct()) {
              Ok(v) -> RestoreTableToPointInTimeErrorTableInUseException(value: v)
              Error(_) -> RestoreTableToPointInTimeErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> RestoreTableToPointInTimeErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_table_not_found_exception_struct()) {
              Ok(v) -> RestoreTableToPointInTimeErrorTableNotFoundException(value: v)
              Error(_) -> RestoreTableToPointInTimeErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> RestoreTableToPointInTimeErrorUnknown(error_type: et, status: s, body: "")
          }
          False -> case bit_array.to_string(b) {
          Ok(text) -> RestoreTableToPointInTimeErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> RestoreTableToPointInTimeErrorUnknown(error_type: et, status: s, body: "")
        }
        }
        }
    ...
    awsjson_client.TransportError(_) -> RestoreTableToPointInTimeErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> RestoreTableToPointInTimeErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> RestoreTableToPointInTimeErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn decode_scan_input(body: String) -> Result(ScanInput, String) {
  case json.parse(body, decode_scan_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}
...
fn translate_scan_error(err: awsjson_client.ClientError) -> ScanError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
        case awsjson_client.error_type_matches(et, "InternalServerError") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_internal_server_error_struct()) {
              Ok(v) -> ScanErrorInternalServerError(value: v)
              Error(_) -> ScanErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> ScanErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "InvalidEndpointException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_invalid_endpoint_exception_struct()) {
              Ok(v) -> ScanErrorInvalidEndpointException(value: v)
              Error(_) -> ScanErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> ScanErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_provisioned_throughput_exceeded_exception_struct()) {
              Ok(v) -> ScanErrorProvisionedThroughputExceededException(value: v)
              Error(_) -> ScanErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> ScanErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_request_limit_exceeded_struct()) {
              Ok(v) -> ScanErrorRequestLimitExceeded(value: v)
              Error(_) -> ScanErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> ScanErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_resource_not_found_exception_struct()) {
              Ok(v) -> ScanErrorResourceNotFoundException(value: v)
              Error(_) -> ScanErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> ScanErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_throttling_exception_struct()) {
              Ok(v) -> ScanErrorThrottlingException(value: v)
              Error(_) -> ScanErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> ScanErrorUnknown(error_type: et, status: s, body: "")
          }
          False -> case bit_array.to_string(b) {
          Ok(text) -> ScanErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> ScanErrorUnknown(error_type: et, status: s, body: "")
        }
        }
        }
    ...
    awsjson_client.TransportError(_) -> ScanErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> ScanErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> ScanErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn decode_tag_resource_input(body: String) -> Result(TagResourceInput, String) {
  case json.parse(body, decode_tag_resource_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}

pub fn decode_tag_resource_output(body: String) -> Result(TagResourceOutput, String) {
...
fn translate_tag_resource_error(err: awsjson_client.ClientError) -> TagResourceError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
        case awsjson_client.error_type_matches(et, "InternalServerError") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_internal_server_error_struct()) {
              Ok(v) -> TagResourceErrorInternalServerError(value: v)
              Error(_) -> TagResourceErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> TagResourceErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "InvalidEndpointException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_invalid_endpoint_exception_struct()) {
              Ok(v) -> TagResourceErrorInvalidEndpointException(value: v)
              Error(_) -> TagResourceErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> TagResourceErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_limit_exceeded_exception_struct()) {
              Ok(v) -> TagResourceErrorLimitExceededException(value: v)
              Error(_) -> TagResourceErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> TagResourceErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_resource_in_use_exception_struct()) {
              Ok(v) -> TagResourceErrorResourceInUseException(value: v)
              Error(_) -> TagResourceErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> TagResourceErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_resource_not_found_exception_struct()) {
              Ok(v) -> TagResourceErrorResourceNotFoundException(value: v)
              Error(_) -> TagResourceErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> TagResourceErrorUnknown(error_type: et, status: s, body: "")
          }
          False -> case bit_array.to_string(b) {
          Ok(text) -> TagResourceErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> TagResourceErrorUnknown(error_type: et, status: s, body: "")
        }
        }
        }
    ...
    awsjson_client.TransportError(_) -> TagResourceErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> TagResourceErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> TagResourceErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn decode_transact_get_items_input(body: String) -> Result(TransactGetItemsInput, String) {
  case json.parse(body, decode_transact_get_items_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}

pub fn decode_transact_get_items_output(body: String) -> Result(TransactGetItemsOutput, String) {
...
fn translate_transact_get_items_error(err: awsjson_client.ClientError) -> TransactGetItemsError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
        case awsjson_client.error_type_matches(et, "InternalServerError") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_internal_server_error_struct()) {
              Ok(v) -> TransactGetItemsErrorInternalServerError(value: v)
              Error(_) -> TransactGetItemsErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> TransactGetItemsErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "InvalidEndpointException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_invalid_endpoint_exception_struct()) {
              Ok(v) -> TransactGetItemsErrorInvalidEndpointException(value: v)
              Error(_) -> TransactGetItemsErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> TransactGetItemsErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_provisioned_throughput_exceeded_exception_struct()) {
              Ok(v) -> TransactGetItemsErrorProvisionedThroughputExceededException(value: v)
              Error(_) -> TransactGetItemsErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> TransactGetItemsErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_request_limit_exceeded_struct()) {
              Ok(v) -> TransactGetItemsErrorRequestLimitExceeded(value: v)
              Error(_) -> TransactGetItemsErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> TransactGetItemsErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_resource_not_found_exception_struct()) {
              Ok(v) -> TransactGetItemsErrorResourceNotFoundException(value: v)
              Error(_) -> TransactGetItemsErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> TransactGetItemsErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_throttling_exception_struct()) {
              Ok(v) -> TransactGetItemsErrorThrottlingException(value: v)
              Error(_) -> TransactGetItemsErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> TransactGetItemsErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_transaction_canceled_exception_struct()) {
              Ok(v) -> TransactGetItemsErrorTransactionCanceledException(value: v)
              Error(_) -> TransactGetItemsErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> TransactGetItemsErrorUnknown(error_type: et, status: s, body: "")
          }
          False -> case bit_array.to_string(b) {
          Ok(text) -> TransactGetItemsErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> TransactGetItemsErrorUnknown(error_type: et, status: s, body: "")
        }
        }
        }
    ...
    awsjson_client.TransportError(_) -> TransactGetItemsErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> TransactGetItemsErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> TransactGetItemsErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn decode_transact_write_items_input(body: String) -> Result(TransactWriteItemsInput, String) {
  case json.parse(body, decode_transact_write_items_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}

pub fn decode_transact_write_items_output(body: String) -> Result(TransactWriteItemsOutput, String) {
...
fn translate_transact_write_items_error(err: awsjson_client.ClientError) -> TransactWriteItemsError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
        case awsjson_client.error_type_matches(et, "IdempotentParameterMismatchException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_idempotent_parameter_mismatch_exception_struct()) {
              Ok(v) -> TransactWriteItemsErrorIdempotentParameterMismatchException(value: v)
              Error(_) -> TransactWriteItemsErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> TransactWriteItemsErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "InternalServerError") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_internal_server_error_struct()) {
              Ok(v) -> TransactWriteItemsErrorInternalServerError(value: v)
              Error(_) -> TransactWriteItemsErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> TransactWriteItemsErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_invalid_endpoint_exception_struct()) {
              Ok(v) -> TransactWriteItemsErrorInvalidEndpointException(value: v)
              Error(_) -> TransactWriteItemsErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> TransactWriteItemsErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_provisioned_throughput_exceeded_exception_struct()) {
              Ok(v) -> TransactWriteItemsErrorProvisionedThroughputExceededException(value: v)
              Error(_) -> TransactWriteItemsErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> TransactWriteItemsErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_request_limit_exceeded_struct()) {
              Ok(v) -> TransactWriteItemsErrorRequestLimitExceeded(value: v)
              Error(_) -> TransactWriteItemsErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> TransactWriteItemsErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_resource_not_found_exception_struct()) {
              Ok(v) -> TransactWriteItemsErrorResourceNotFoundException(value: v)
              Error(_) -> TransactWriteItemsErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> TransactWriteItemsErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_throttling_exception_struct()) {
              Ok(v) -> TransactWriteItemsErrorThrottlingException(value: v)
              Error(_) -> TransactWriteItemsErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> TransactWriteItemsErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_transaction_canceled_exception_struct()) {
              Ok(v) -> TransactWriteItemsErrorTransactionCanceledException(value: v)
              Error(_) -> TransactWriteItemsErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> TransactWriteItemsErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_transaction_in_progress_exception_struct()) {
              Ok(v) -> TransactWriteItemsErrorTransactionInProgressException(value: v)
              Error(_) -> TransactWriteItemsErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> TransactWriteItemsErrorUnknown(error_type: et, status: s, body: "")
          }
          False -> case bit_array.to_string(b) {
          Ok(text) -> TransactWriteItemsErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> TransactWriteItemsErrorUnknown(error_type: et, status: s, body: "")
        }
        }
        }
    ...
    awsjson_client.TransportError(_) -> TransactWriteItemsErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> TransactWriteItemsErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> TransactWriteItemsErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn encode_untag_resource_output_struct(_v: UntagResourceOutput) -> json.Json {
  json.object([])
}

pub fn decode_untag_resource_output_struct() -> decode.Decoder(UntagResourceOutput) {
...
pub fn decode_untag_resource_input(body: String) -> Result(UntagResourceInput, String) {
  case json.parse(body, decode_untag_resource_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}

pub fn decode_untag_resource_output(body: String) -> Result(UntagResourceOutput, String) {
...
fn translate_untag_resource_error(err: awsjson_client.ClientError) -> UntagResourceError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
        case awsjson_client.error_type_matches(et, "InternalServerError") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_internal_server_error_struct()) {
              Ok(v) -> UntagResourceErrorInternalServerError(value: v)
              Error(_) -> UntagResourceErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> UntagResourceErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "InvalidEndpointException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_invalid_endpoint_exception_struct()) {
              Ok(v) -> UntagResourceErrorInvalidEndpointException(value: v)
              Error(_) -> UntagResourceErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> UntagResourceErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_limit_exceeded_exception_struct()) {
              Ok(v) -> UntagResourceErrorLimitExceededException(value: v)
              Error(_) -> UntagResourceErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> UntagResourceErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_resource_in_use_exception_struct()) {
              Ok(v) -> UntagResourceErrorResourceInUseException(value: v)
              Error(_) -> UntagResourceErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> UntagResourceErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_resource_not_found_exception_struct()) {
              Ok(v) -> UntagResourceErrorResourceNotFoundException(value: v)
              Error(_) -> UntagResourceErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> UntagResourceErrorUnknown(error_type: et, status: s, body: "")
          }
          False -> case bit_array.to_string(b) {
          Ok(text) -> UntagResourceErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> UntagResourceErrorUnknown(error_type: et, status: s, body: "")
        }
        }
        }
    ...
    awsjson_client.TransportError(_) -> UntagResourceErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> UntagResourceErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> UntagResourceErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn decode_update_continuous_backups_input(body: String) -> Result(UpdateContinuousBackupsInput, String) {
  case json.parse(body, decode_update_continuous_backups_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}

pub fn decode_update_continuous_backups_output(body: String) -> Result(UpdateContinuousBackupsOutput, String) {
...
fn translate_update_continuous_backups_error(err: awsjson_client.ClientError) -> UpdateContinuousBackupsError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
        case awsjson_client.error_type_matches(et, "ContinuousBackupsUnavailableException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_continuous_backups_unavailable_exception_struct()) {
              Ok(v) -> UpdateContinuousBackupsErrorContinuousBackupsUnavailableException(value: v)
              Error(_) -> UpdateContinuousBackupsErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> UpdateContinuousBackupsErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "InternalServerError") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_internal_server_error_struct()) {
              Ok(v) -> UpdateContinuousBackupsErrorInternalServerError(value: v)
              Error(_) -> UpdateContinuousBackupsErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> UpdateContinuousBackupsErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_invalid_endpoint_exception_struct()) {
              Ok(v) -> UpdateContinuousBackupsErrorInvalidEndpointException(value: v)
              Error(_) -> UpdateContinuousBackupsErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> UpdateContinuousBackupsErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_table_not_found_exception_struct()) {
              Ok(v) -> UpdateContinuousBackupsErrorTableNotFoundException(value: v)
              Error(_) -> UpdateContinuousBackupsErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> UpdateContinuousBackupsErrorUnknown(error_type: et, status: s, body: "")
          }
          False -> case bit_array.to_string(b) {
          Ok(text) -> UpdateContinuousBackupsErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> UpdateContinuousBackupsErrorUnknown(error_type: et, status: s, body: "")
        }
        }
        }
    ...
    awsjson_client.TransportError(_) -> UpdateContinuousBackupsErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> UpdateContinuousBackupsErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> UpdateContinuousBackupsErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn decode_update_contributor_insights_input(body: String) -> Result(UpdateContributorInsightsInput, String) {
  case json.parse(body, decode_update_contributor_insights_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}

pub fn decode_update_contributor_insights_output(body: String) -> Result(UpdateContributorInsightsOutput, String) {
...
fn translate_update_contributor_insights_error(err: awsjson_client.ClientError) -> UpdateContributorInsightsError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
        case awsjson_client.error_type_matches(et, "InternalServerError") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_internal_server_error_struct()) {
              Ok(v) -> UpdateContributorInsightsErrorInternalServerError(value: v)
              Error(_) -> UpdateContributorInsightsErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> UpdateContributorInsightsErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "ResourceNotFoundException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_resource_not_found_exception_struct()) {
              Ok(v) -> UpdateContributorInsightsErrorResourceNotFoundException(value: v)
              Error(_) -> UpdateContributorInsightsErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> UpdateContributorInsightsErrorUnknown(error_type: et, status: s, body: "")
          }
          False -> case bit_array.to_string(b) {
          Ok(text) -> UpdateContributorInsightsErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> UpdateContributorInsightsErrorUnknown(error_type: et, status: s, body: "")
        }
        }
        }
    }
    awsjson_client.TransportError(_) -> UpdateContributorInsightsErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> UpdateContributorInsightsErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> UpdateContributorInsightsErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn decode_update_global_table_input(body: String) -> Result(UpdateGlobalTableInput, String) {
  case json.parse(body, decode_update_global_table_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}

pub fn decode_update_global_table_output(body: String) -> Result(UpdateGlobalTableOutput, String) {
...
fn translate_update_global_table_error(err: awsjson_client.ClientError) -> UpdateGlobalTableError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
        case awsjson_client.error_type_matches(et, "GlobalTableNotFoundException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_global_table_not_found_exception_struct()) {
              Ok(v) -> UpdateGlobalTableErrorGlobalTableNotFoundException(value: v)
              Error(_) -> UpdateGlobalTableErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> UpdateGlobalTableErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "InternalServerError") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_internal_server_error_struct()) {
              Ok(v) -> UpdateGlobalTableErrorInternalServerError(value: v)
              Error(_) -> UpdateGlobalTableErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> UpdateGlobalTableErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_invalid_endpoint_exception_struct()) {
              Ok(v) -> UpdateGlobalTableErrorInvalidEndpointException(value: v)
              Error(_) -> UpdateGlobalTableErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> UpdateGlobalTableErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "ReplicaAlreadyExistsException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_replica_already_exists_exception_struct()) {
              Ok(v) -> UpdateGlobalTableErrorReplicaAlreadyExistsException(value: v)
              Error(_) -> UpdateGlobalTableErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> UpdateGlobalTableErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "ReplicaNotFoundException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_replica_not_found_exception_struct()) {
              Ok(v) -> UpdateGlobalTableErrorReplicaNotFoundException(value: v)
              Error(_) -> UpdateGlobalTableErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> UpdateGlobalTableErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_table_not_found_exception_struct()) {
              Ok(v) -> UpdateGlobalTableErrorTableNotFoundException(value: v)
              Error(_) -> UpdateGlobalTableErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> UpdateGlobalTableErrorUnknown(error_type: et, status: s, body: "")
          }
          False -> case bit_array.to_string(b) {
          Ok(text) -> UpdateGlobalTableErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> UpdateGlobalTableErrorUnknown(error_type: et, status: s, body: "")
        }
        }
        }
    ...
    awsjson_client.TransportError(_) -> UpdateGlobalTableErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> UpdateGlobalTableErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> UpdateGlobalTableErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn decode_update_global_table_settings_input(body: String) -> Result(UpdateGlobalTableSettingsInput, String) {
  case json.parse(body, decode_update_global_table_settings_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}

pub fn decode_update_global_table_settings_output(body: String) -> Result(UpdateGlobalTableSettingsOutput, String) {
...
fn translate_update_global_table_settings_error(err: awsjson_client.ClientError) -> UpdateGlobalTableSettingsError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
        case awsjson_client.error_type_matches(et, "GlobalTableNotFoundException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_global_table_not_found_exception_struct()) {
              Ok(v) -> UpdateGlobalTableSettingsErrorGlobalTableNotFoundException(value: v)
              Error(_) -> UpdateGlobalTableSettingsErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> UpdateGlobalTableSettingsErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "IndexNotFoundException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_index_not_found_exception_struct()) {
              Ok(v) -> UpdateGlobalTableSettingsErrorIndexNotFoundException(value: v)
              Error(_) -> UpdateGlobalTableSettingsErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> UpdateGlobalTableSettingsErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_internal_server_error_struct()) {
              Ok(v) -> UpdateGlobalTableSettingsErrorInternalServerError(value: v)
              Error(_) -> UpdateGlobalTableSettingsErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> UpdateGlobalTableSettingsErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_invalid_endpoint_exception_struct()) {
              Ok(v) -> UpdateGlobalTableSettingsErrorInvalidEndpointException(value: v)
              Error(_) -> UpdateGlobalTableSettingsErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> UpdateGlobalTableSettingsErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_limit_exceeded_exception_struct()) {
              Ok(v) -> UpdateGlobalTableSettingsErrorLimitExceededException(value: v)
              Error(_) -> UpdateGlobalTableSettingsErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> UpdateGlobalTableSettingsErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_replica_not_found_exception_struct()) {
              Ok(v) -> UpdateGlobalTableSettingsErrorReplicaNotFoundException(value: v)
              Error(_) -> UpdateGlobalTableSettingsErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> UpdateGlobalTableSettingsErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_resource_in_use_exception_struct()) {
              Ok(v) -> UpdateGlobalTableSettingsErrorResourceInUseException(value: v)
              Error(_) -> UpdateGlobalTableSettingsErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> UpdateGlobalTableSettingsErrorUnknown(error_type: et, status: s, body: "")
          }
          False -> case bit_array.to_string(b) {
          Ok(text) -> UpdateGlobalTableSettingsErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> UpdateGlobalTableSettingsErrorUnknown(error_type: et, status: s, body: "")
        }
        }
        }
    ...
    awsjson_client.TransportError(_) -> UpdateGlobalTableSettingsErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> UpdateGlobalTableSettingsErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> UpdateGlobalTableSettingsErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn decode_update_item_input(body: String) -> Result(UpdateItemInput, String) {
  case json.parse(body, decode_update_item_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}

pub fn decode_update_item_output(body: String) -> Result(UpdateItemOutput, String) {
...
fn translate_update_item_error(err: awsjson_client.ClientError) -> UpdateItemError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
        case awsjson_client.error_type_matches(et, "ConditionalCheckFailedException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_conditional_check_failed_exception_struct()) {
              Ok(v) -> UpdateItemErrorConditionalCheckFailedException(value: v)
              Error(_) -> UpdateItemErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> UpdateItemErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "InternalServerError") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_internal_server_error_struct()) {
              Ok(v) -> UpdateItemErrorInternalServerError(value: v)
              Error(_) -> UpdateItemErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> UpdateItemErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_invalid_endpoint_exception_struct()) {
              Ok(v) -> UpdateItemErrorInvalidEndpointException(value: v)
              Error(_) -> UpdateItemErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> UpdateItemErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_item_collection_size_limit_exceeded_exception_struct()) {
              Ok(v) -> UpdateItemErrorItemCollectionSizeLimitExceededException(value: v)
              Error(_) -> UpdateItemErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> UpdateItemErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_provisioned_throughput_exceeded_exception_struct()) {
              Ok(v) -> UpdateItemErrorProvisionedThroughputExceededException(value: v)
              Error(_) -> UpdateItemErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> UpdateItemErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_replicated_write_conflict_exception_struct()) {
              Ok(v) -> UpdateItemErrorReplicatedWriteConflictException(value: v)
              Error(_) -> UpdateItemErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> UpdateItemErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_request_limit_exceeded_struct()) {
              Ok(v) -> UpdateItemErrorRequestLimitExceeded(value: v)
              Error(_) -> UpdateItemErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> UpdateItemErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_resource_not_found_exception_struct()) {
              Ok(v) -> UpdateItemErrorResourceNotFoundException(value: v)
              Error(_) -> UpdateItemErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> UpdateItemErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_throttling_exception_struct()) {
              Ok(v) -> UpdateItemErrorThrottlingException(value: v)
              Error(_) -> UpdateItemErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> UpdateItemErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_transaction_conflict_exception_struct()) {
              Ok(v) -> UpdateItemErrorTransactionConflictException(value: v)
              Error(_) -> UpdateItemErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> UpdateItemErrorUnknown(error_type: et, status: s, body: "")
          }
          False -> case bit_array.to_string(b) {
          Ok(text) -> UpdateItemErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> UpdateItemErrorUnknown(error_type: et, status: s, body: "")
        }
        }
        }
    ...
    awsjson_client.TransportError(_) -> UpdateItemErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> UpdateItemErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> UpdateItemErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn decode_update_kinesis_streaming_destination_input(body: String) -> Result(UpdateKinesisStreamingDestinationInput, String) {
  case json.parse(body, decode_update_kinesis_streaming_destination_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}

pub fn decode_update_kinesis_streaming_destination_output(body: String) -> Result(UpdateKinesisStreamingDestinationOutput, String) {
  case json.parse(body, decode_update_kinesis_streaming_destination_output_struct()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}
...
fn translate_update_kinesis_streaming_destination_error(err: awsjson_client.ClientError) -> UpdateKinesisStreamingDestinationError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
        case awsjson_client.error_type_matches(et, "InternalServerError") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_internal_server_error_struct()) {
              Ok(v) -> UpdateKinesisStreamingDestinationErrorInternalServerError(value: v)
              Error(_) -> UpdateKinesisStreamingDestinationErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> UpdateKinesisStreamingDestinationErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "InvalidEndpointException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_invalid_endpoint_exception_struct()) {
              Ok(v) -> UpdateKinesisStreamingDestinationErrorInvalidEndpointException(value: v)
              Error(_) -> UpdateKinesisStreamingDestinationErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> UpdateKinesisStreamingDestinationErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_limit_exceeded_exception_struct()) {
              Ok(v) -> UpdateKinesisStreamingDestinationErrorLimitExceededException(value: v)
              Error(_) -> UpdateKinesisStreamingDestinationErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> UpdateKinesisStreamingDestinationErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_resource_in_use_exception_struct()) {
              Ok(v) -> UpdateKinesisStreamingDestinationErrorResourceInUseException(value: v)
              Error(_) -> UpdateKinesisStreamingDestinationErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> UpdateKinesisStreamingDestinationErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_resource_not_found_exception_struct()) {
              Ok(v) -> UpdateKinesisStreamingDestinationErrorResourceNotFoundException(value: v)
              Error(_) -> UpdateKinesisStreamingDestinationErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> UpdateKinesisStreamingDestinationErrorUnknown(error_type: et, status: s, body: "")
          }
          False -> case bit_array.to_string(b) {
          Ok(text) -> UpdateKinesisStreamingDestinationErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> UpdateKinesisStreamingDestinationErrorUnknown(error_type: et, status: s, body: "")
        }
        }
        }
    ...
    awsjson_client.TransportError(_) -> UpdateKinesisStreamingDestinationErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> UpdateKinesisStreamingDestinationErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> UpdateKinesisStreamingDestinationErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn decode_update_table_input(body: String) -> Result(UpdateTableInput, String) {
  case json.parse(body, decode_update_table_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}

pub fn decode_update_table_output(body: String) -> Result(UpdateTableOutput, String) {
...
fn translate_update_table_error(err: awsjson_client.ClientError) -> UpdateTableError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
        case awsjson_client.error_type_matches(et, "InternalServerError") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_internal_server_error_struct()) {
              Ok(v) -> UpdateTableErrorInternalServerError(value: v)
              Error(_) -> UpdateTableErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> UpdateTableErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "InvalidEndpointException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_invalid_endpoint_exception_struct()) {
              Ok(v) -> UpdateTableErrorInvalidEndpointException(value: v)
              Error(_) -> UpdateTableErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> UpdateTableErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_limit_exceeded_exception_struct()) {
              Ok(v) -> UpdateTableErrorLimitExceededException(value: v)
              Error(_) -> UpdateTableErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> UpdateTableErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_resource_in_use_exception_struct()) {
              Ok(v) -> UpdateTableErrorResourceInUseException(value: v)
              Error(_) -> UpdateTableErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> UpdateTableErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_resource_not_found_exception_struct()) {
              Ok(v) -> UpdateTableErrorResourceNotFoundException(value: v)
              Error(_) -> UpdateTableErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> UpdateTableErrorUnknown(error_type: et, status: s, body: "")
          }
          False -> case bit_array.to_string(b) {
          Ok(text) -> UpdateTableErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> UpdateTableErrorUnknown(error_type: et, status: s, body: "")
        }
        }
        }
    ...
    awsjson_client.TransportError(_) -> UpdateTableErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> UpdateTableErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> UpdateTableErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn decode_update_table_replica_auto_scaling_input(body: String) -> Result(UpdateTableReplicaAutoScalingInput, String) {
  case json.parse(body, decode_update_table_replica_auto_scaling_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}

pub fn decode_update_table_replica_auto_scaling_output(body: String) -> Result(UpdateTableReplicaAutoScalingOutput, String) {
  case json.parse(body, decode_update_table_replica_auto_scaling_output_struct()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}
...
fn translate_update_table_replica_auto_scaling_error(err: awsjson_client.ClientError) -> UpdateTableReplicaAutoScalingError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
        case awsjson_client.error_type_matches(et, "InternalServerError") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_internal_server_error_struct()) {
              Ok(v) -> UpdateTableReplicaAutoScalingErrorInternalServerError(value: v)
              Error(_) -> UpdateTableReplicaAutoScalingErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> UpdateTableReplicaAutoScalingErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "LimitExceededException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_limit_exceeded_exception_struct()) {
              Ok(v) -> UpdateTableReplicaAutoScalingErrorLimitExceededException(value: v)
              Error(_) -> UpdateTableReplicaAutoScalingErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> UpdateTableReplicaAutoScalingErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_resource_in_use_exception_struct()) {
              Ok(v) -> UpdateTableReplicaAutoScalingErrorResourceInUseException(value: v)
              Error(_) -> UpdateTableReplicaAutoScalingErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> UpdateTableReplicaAutoScalingErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_resource_not_found_exception_struct()) {
              Ok(v) -> UpdateTableReplicaAutoScalingErrorResourceNotFoundException(value: v)
              Error(_) -> UpdateTableReplicaAutoScalingErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> UpdateTableReplicaAutoScalingErrorUnknown(error_type: et, status: s, body: "")
          }
          False -> case bit_array.to_string(b) {
          Ok(text) -> UpdateTableReplicaAutoScalingErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> UpdateTableReplicaAutoScalingErrorUnknown(error_type: et, status: s, body: "")
        }
        }
        }
    ...
    awsjson_client.TransportError(_) -> UpdateTableReplicaAutoScalingErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> UpdateTableReplicaAutoScalingErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> UpdateTableReplicaAutoScalingErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn decode_update_time_to_live_input(body: String) -> Result(UpdateTimeToLiveInput, String) {
  case json.parse(body, decode_update_time_to_live_input_struct_params()) {
    Ok(v) -> Ok(v)
    Error(_) -> Error("decode failed")
  }
}

pub fn decode_update_time_to_live_output(body: String) -> Result(UpdateTimeToLiveOutput, String) {
...
fn translate_update_time_to_live_error(err: awsjson_client.ClientError) -> UpdateTimeToLiveError {
  case err {
    awsjson_client.ServiceError(status: s, error_type: et, body: b) -> {
        case awsjson_client.error_type_matches(et, "InternalServerError") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_internal_server_error_struct()) {
              Ok(v) -> UpdateTimeToLiveErrorInternalServerError(value: v)
              Error(_) -> UpdateTimeToLiveErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> UpdateTimeToLiveErrorUnknown(error_type: et, status: s, body: "")
          }
          False ->         case awsjson_client.error_type_matches(et, "InvalidEndpointException") {
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_invalid_endpoint_exception_struct()) {
              Ok(v) -> UpdateTimeToLiveErrorInvalidEndpointException(value: v)
              Error(_) -> UpdateTimeToLiveErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> UpdateTimeToLiveErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_limit_exceeded_exception_struct()) {
              Ok(v) -> UpdateTimeToLiveErrorLimitExceededException(value: v)
              Error(_) -> UpdateTimeToLiveErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> UpdateTimeToLiveErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_resource_in_use_exception_struct()) {
              Ok(v) -> UpdateTimeToLiveErrorResourceInUseException(value: v)
              Error(_) -> UpdateTimeToLiveErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> UpdateTimeToLiveErrorUnknown(error_type: et, status: s, body: "")
          }
          ...
          True -> case bit_array.to_string(b) {
            Ok(text) -> case json.parse(text, decode_resource_not_found_exception_struct()) {
              Ok(v) -> UpdateTimeToLiveErrorResourceNotFoundException(value: v)
              Error(_) -> UpdateTimeToLiveErrorUnknown(error_type: et, status: s, body: text)
            }
            Error(_) -> UpdateTimeToLiveErrorUnknown(error_type: et, status: s, body: "")
          }
          False -> case bit_array.to_string(b) {
          Ok(text) -> UpdateTimeToLiveErrorUnknown(error_type: et, status: s, body: text)
          Error(_) -> UpdateTimeToLiveErrorUnknown(error_type: et, status: s, body: "")
        }
        }
        }
    ...
    awsjson_client.TransportError(_) -> UpdateTimeToLiveErrorTransport(reason: "transport error")
    awsjson_client.CredentialsError(_) -> UpdateTimeToLiveErrorTransport(reason: "credentials error")
    awsjson_client.DecodeError(reason: r) -> UpdateTimeToLiveErrorTransport(reason: "decode: " <> r)
  }
}
...
pub fn describe_kinesis_streaming_destination(
  client: Client,
  input: DescribeKinesisStreamingDestinationInput,
) -> Result(DescribeKinesisStreamingDestinationOutput, DescribeKinesisStreamingDestinationError) {
  case awsjson_client.invoke(
    client.config,
    ...
    Ok(out) -> Ok(out)
    Error(err) -> Error(translate_describe_kinesis_streaming_destination_error(err))
  }
}
...
pub fn describe_table_replica_auto_scaling(
  client: Client,
  input: DescribeTableReplicaAutoScalingInput,
) -> Result(DescribeTableReplicaAutoScalingOutput, DescribeTableReplicaAutoScalingError) {
  case awsjson_client.invoke(
    client.config,
    ...
    Ok(out) -> Ok(out)
    Error(err) -> Error(translate_describe_table_replica_auto_scaling_error(err))
  }
}
...
pub fn disable_kinesis_streaming_destination(
  client: Client,
  input: KinesisStreamingDestinationInput,
) -> Result(KinesisStreamingDestinationOutput, DisableKinesisStreamingDestinationError) {
  case awsjson_client.invoke(
    client.config,
    ...
    Ok(out) -> Ok(out)
    Error(err) -> Error(translate_disable_kinesis_streaming_destination_error(err))
  }
}
...
pub fn enable_kinesis_streaming_destination(
  client: Client,
  input: KinesisStreamingDestinationInput,
) -> Result(KinesisStreamingDestinationOutput, EnableKinesisStreamingDestinationError) {
  case awsjson_client.invoke(
    client.config,
    ...
    Ok(out) -> Ok(out)
    Error(err) -> Error(translate_enable_kinesis_streaming_destination_error(err))
  }
}
...
pub fn update_kinesis_streaming_destination(
  client: Client,
  input: UpdateKinesisStreamingDestinationInput,
) -> Result(UpdateKinesisStreamingDestinationOutput, UpdateKinesisStreamingDestinationError) {
  case awsjson_client.invoke(
    client.config,
    ...
    Ok(out) -> Ok(out)
    Error(err) -> Error(translate_update_kinesis_streaming_destination_error(err))
  }
}
...
pub fn update_table_replica_auto_scaling(
  client: Client,
  input: UpdateTableReplicaAutoScalingInput,
) -> Result(UpdateTableReplicaAutoScalingOutput, UpdateTableReplicaAutoScalingError) {
  case awsjson_client.invoke(
    client.config,
